    ...
    if ($yetki['demo'] != '1') {
        ...
        foreach ($position as $idler) {
            ...
            try {
                ...
                $query = $db->query("UPDATE hizmet SET sira = '$count' WHERE id = '$idler2'");
...
if ($yetki['demo'] != '1') {
    ...
    if(isset($_GET['status_update'])  ) {
        if ($_GET['status_update'] == !null) {
            ...
            $statusCek = $db->prepare("select * from hizmet where id=:id ");
         ...
         ");
                ...
                if ($sonuc) {
                    header('Location:' . $ayar['panel_url'] . 'pages.php?page=services' . $sayfa . ''.$searchPage.'');
                } else {
...
?>
<title><?=$diller['adminpanel-menu-text-57']?> - <?=$panelayar['baslik']?></title>
<style>
    .nav-link{
        color: #000;
...
<div class="wrapper" style="margin-top: 0;">
    <div class="container-fluid">
                    ...
                    <div class="row align-items-center" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=services"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-57']?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php if($yetki['icerik_yonetim'] == '1' && $yetki['blog_hizmet'] == '1' ) {
            ...
            if(isset($_GET['search']) && $_GET['search']== !null  ) {
                $search = "and (baslik like '%$_GET[search]%' or spot like '%$_GET[search]%' or icerik like '%$_GET[search]%' or meta_desc like '%$_GET[search]%') ";
            }else{
                $search = null;
            }
            ...
            $Say = $db->query("select * from  hizmet where dil='$_SESSION[dil]'  $search ");
            $ToplamVeri = $Say->rowCount();
            $Limit = 30 ;
            $Sayfa_Sayisi = ceil($ToplamVeri/$Limit); if($Sayfa > $Sayfa_Sayisi){$Sayfa = 1;}
            $Goster = $Sayfa * $Limit - $Limit;
            $GorunenSayfa = 5;
            $islemListele = $db->query("select * from hizmet where dil='$_SESSION[dil]' $search order by sira ASC limit $Goster,$Limit");
                    ...
                    <div class="card p-3">
                        <div class="new-buttonu-main-top border-bottom pb-2 mb-0">
                            <div class="new-buttonu-main-left">
                                <h4> <?=$diller['adminpanel-menu-text-57']?></h4>
                                <?=$diller['adminpanel-form-text-1124']?> <?=$ToplamVeri?>
                            </div>
                            <div class="new-buttonu-main">
                                <a  class="btn btn-success text-white "  data-toggle="collapse" data-target="#genelAcc" aria-expanded="false" aria-controls="collapseForm"><i class="fas fa-plus-circle "></i> <?=$diller['adminpanel-form-text-1126']?></a>
                                <div class="dropdown">
                        ...
                        <div id="accordion" class="accordion">
                            <div class="collapse  " id="genelAcc" data-parent="#accordion">
                                <form action="post.php?process=services_post&status=add" method="post" class="border border-top-0 mb-5 " enctype="multipart/form-data">
                                            ...
                                            <div class="tab-pane active p-4" id="one" role="tabpanel" >
                                               <div class="row">
                                                   ...
                                                   <div class="form-group col-md-8">
                                                       <label for="baslik">* <?=$diller['adminpanel-form-text-1131']?></label>
                                                   ...
                                                   <div class="form-group col-md-12 mb-3">
                                                       <div class="border  p-3 rounded ">
                                                           <label  for="inputGroupFile01" class="w-100">* <?=$diller['adminpanel-form-text-1127']?> (600x320)  <small>( png,  jpg, jpeg, gif, svg )</small></label>
                                                   ...
                                                   <div class="form-group col-md-12">
                                                       <label for="spot"><?=$diller['adminpanel-form-text-1129']?></label>
                                                       <textarea name="spot" id="spot" class="form-control" rows="2" ></textarea>
                                                   </div>
                                                   <div class="form-group col-md-12">
                                                       <label for="icerik">* <?=$diller['adminpanel-form-text-1130']?></label>
                            ...
                            <div class="row ">
                                <div class="col-md-7 ">
                                    <?php if(isset($_GET['search'])  && $_GET['search']==!null ) {?>
                                        ...
                                        <a href="pages.php?page=services" class="btn btn-sm btn-info shadow"><?=$_GET['search']?> <i class="fa fa-times"></i></a>
                                    <?php }?>
                                </div>
                        ...
                        <div class="w-100">
                            <form method="post" action="post.php?process=services_post&status=multidelete">
                            <div class="table-responsive ">
                                <table class="table table-hover mb-0  ">
                                    ...
                                    <tr>
                                        ...
                                        <th></th>
                                        <th><?=$diller['adminpanel-form-text-1131']?></th>
                                        ...
                                        <tr id="<?php echo $row['id'] ?>" style="cursor: move">
                                            ...
                                            <td style="width: 50px">
                                                <?php if($row['gorsel'] == !null ) {?>
                                                    <img src="<?=$ayar['site_url']?>images/services/<?=$row['gorsel']?>"  style="width: 40px;">
                                                <?php }?>
                                            </td>
                                            <td style="min-width: 220px; font-size: 13px ;">
                                                <?=$row['baslik']?>
                                            </td>
                                            <td   style="font-size: 12px ; min-width: 200px" width="200">
                                            ...
                                            <td width="85" style="text-align: center;">
                                                ...
                                                <?php if($row['anasayfa'] == '0' ) {?>
                                                    <a class="btn btn-sm btn-outline-danger " href="pages.php?page=services&home_update=<?=$row['id']?><?=$sayfa?><?=$searchPage?>">
                                                ...
                                                <?php if($row['anasayfa'] == '1' ) {?>
                                                    <a class="btn btn-sm btn-outline-success " href="pages.php?page=services&home_update=<?=$row['id']?><?=$sayfa?><?=$searchPage?>">
                                                        <div class="d-flex align-items-center">
                                            ...
                                            <td width="85">
                                                <?php if($row['durum'] == '0' ) {?>
                                                    <a class="btn btn-sm btn-outline-danger " href="pages.php?page=services&status_update=<?=$row['id']?><?=$sayfa?><?=$searchPage?>">
                                                        <div class="d-flex align-items-center">
                                                            <i class="fa fa-times mr-2"></i>
                                                            <?=$diller['adminpanel-form-text-68']?>
                                                        </div>
                                                ...
                                                <?php }?>
                                                <?php if($row['durum'] == '1' ) {?>
                                                    <a class="btn btn-sm btn-success " href="pages.php?page=services&status_update=<?=$row['id']?><?=$sayfa?><?=$searchPage?>">
                                                        <div class="d-flex align-items-center">
                                            ...
                                            <td class="text-right" style="min-width: 100px">
                                                <a class="btn btn-sm btn-warning" target="_blank" href="<?=$ayar['site_url']?>hizmet/<?=$row['seo_url']?>/" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1132']?>">
                                                ...
                                                <a href="" data-href="post.php?process=services_post&status=delete&no=<?=$row['id']?>"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger "><i class="fa fa-trash" ></i></a>
                                            </td>
                                        </tr>
                                    <?php }?>
                                    </tbody>
                                ...
                                <div id="SayfalamaElementi" class="w-100 p-2  border-bottom bg-light  ">
                                    ...
                                    <nav aria-label="Page navigation example " >
                                        <ul class="pagination pagination-sm justify-content-end mb-0 ">
                                            <?php } ?>
                                            <?php if($Sayfa > 1){  ?>
                                                <li class="page-item "><a class="page-link " href="pages.php?page=services<?=$searchPage?>"><?=$diller['sayfalama-ilk']?></a></li>
                                                <li class="page-item "><a class="page-link " href="pages.php?page=services<?=$searchPage?>&p=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                                            <?php } ?>
                                            <?php
                                            for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                                                if($i == $Sayfa){
                                                    ...
                                                    <li class="page-item active " aria-current="page">
                                                        <a class="page-link" href="pages.php?page=services<?=$searchPage?>&p=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>
                                                    </li>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <li class="page-item "><a class="page-link" href="pages.php?page=services<?=$searchPage?>&p=<?=$i?>"><?=$i?></a></li>
                                                    <?php
                                                }
                                            }
                                            }
                                            ...
                                            <?php if($islemListele->rowCount() <=0) { } else { ?>
                                                <?php if($Sayfa != $Sayfa_Sayisi){?>
                                                    <li class="page-item"><a class="page-link" href="pages.php?page=services<?=$searchPage?>&p=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                                                    <li class="page-item"><a class="page-link" href="pages.php?page=services<?=$searchPage?>&p=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                                                <?php }} ?>
                                            <?php if($Sayfa >= 1){?>
                                        </ul>
                                    </nav>
...
<script type='text/javascript'>
    $(document).ready(function(){
        ...
        $('.duzenleAjax').click(function(){
            ...
            // AJAX request
            $.ajax({
                url: 'masterpiece.php?page=services_edit',
                type: 'post',
                data: {postID: postID},
