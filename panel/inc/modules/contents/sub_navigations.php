    ...
    if($yetki['demo'] != '1' ) {
        if($_GET['status_update'] == !null  ) {
         ...
         ");
                ...
                if($sonuc){
                    header('Location:'.$ayar['panel_url'].'pages.php?page=sub_navigations'.$searchPage.'');
                }else{
...
?>
<title><?=$diller['adminpanel-menu-text-42']?> - <?=$panelayar['baslik']?></title>
...
<div class="wrapper" style="margin-top: 0;">
    <div class="container-fluid">
        ...
        <?php if($yetki['icerik_yonetim'] == '1' &&  $yetki['sayfa_yonet'] == '1') {
            ...
            $navigasyonSql = $db->prepare("select * from navigasyon where $search dil=:dil and ust_id=:ust_id order by sira asc ");
            $navigasyonSql->execute(array(
                    'dil' => $_SESSION['dil'],
                    'ust_id' => '0'
            ));
            ...
            <div class="row">
                ...
                $sssSet = $db->prepare("select nav_durum from sss_ayar where id='1' ");
                $sssSet->execute();
                $sssayar = $sssSet->fetch(PDO::FETCH_ASSOC);


                $vidSet = $db->prepare("select nav from video_ayar where id='1' ");
                $vidSet->execute();
                $vidayar = $vidSet->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="card p-3">
                        <div class="new-buttonu-main-top border-bottom pb-2 mb-0">
                            <div class="new-buttonu-main-left">
                                <h4> <?=$diller['adminpanel-menu-text-42']?></h4>
                            </div>
                            <div class="new-buttonu-main">
                                <a  class="btn btn-primary text-white "  data-toggle="collapse" data-target="#infoAcc" aria-expanded="false" aria-controls="collapseForm"><i class="fas fa-plus-circle "></i> <?=$diller['adminpanel-form-text-1002']?></a>
                                <a  class="btn btn-pink text-white "  data-toggle="collapse" data-target="#fontAcc" aria-expanded="false" aria-controls="collapseForm"><i class="fas fa-plus-circle "></i> <?=$diller['adminpanel-form-text-1000']?></a>
                        ...
                        <div id="accordion" class="accordion">
                            <div class="collapse  " id="infoAcc" data-parent="#accordion">
                                <div class="w-100 border pl-3 pr-3 mb-3">
                                        <div class="row ">
                                            <div class="form-group  pt-2 pb-2 col-md-12 bg-light text-dark border-bottom mb-0 ">
                                                <h6> <?=$diller['adminpanel-form-text-1003']?></h6>
                                                <div class="mb-2" style="font-size: 14px ;">
                                                    <?=$diller['adminpanel-form-text-1004']?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-start flex-wrap ">
                                            <?php if($ayar['iletisim_sayfa_nav'] == '0' ) {?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1005']?>">
                                                    <?=$diller['adminpanel-menu-text-62']?> <i class="fa fa-times text-danger" ></i>
                                                </div>
                                            <?php }else { ?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1006']?>">
                                                    <?=$diller['adminpanel-menu-text-62']?> <i class="fa fa-check text-success" ></i>
                                                </div>
                                            <?php }?>
                                            <?php if($sssayar['nav_durum'] == '0' ) {?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1005']?>">
                                                    <?=$diller['adminpanel-menu-text-52']?> <i class="fa fa-times text-danger" ></i>
                                                </div>
                                            <?php }else { ?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1006']?>">
                                                    <?=$diller['adminpanel-menu-text-52']?> <i class="fa fa-check text-success" ></i>
                                                </div>
                                            <?php }?>
                                            <?php if($ayar['banka_sayfa_nav'] == '0' ) {?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1005']?>">
                                                    <?=$diller['adminpanel-menu-text-80']?> <i class="fa fa-times text-danger" ></i>
                                                </div>
                                            <?php }else { ?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1006']?>">
                                                    <?=$diller['adminpanel-menu-text-80']?> <i class="fa fa-check text-success" ></i>
                                                </div>
                                            <?php }?>
                                            <?php if($vidayar['nav'] == '0' ) {?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1005']?>">
                                                    <?=$diller['adminpanel-menu-text-60']?> <i class="fa fa-times text-danger" ></i>
                                                </div>
                                            <?php }else { ?>
                                                <div class="border-right pr-3 mr-3 mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1006']?>">
                                                    <?=$diller['adminpanel-menu-text-60']?> <i class="fa fa-check text-success" ></i>
                                                </div>
                                            <?php }?>
                                            <div class="mt-3 mb-3" style="cursor: pointer" data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-1007']?>">
                                                <?=$diller['adminpanel-text-343']?> <i class="fa fa-question-circle text-primary" ></i>
                                            </div>
                                        </div>
                                        <div class="row border-top  bg-light pb-3 pt-3">
                                            <div class="col-md-12 text-right">
                                                <a class="btn  btn-secondary text-white" data-toggle="collapse" data-target="#infoAcc" aria-expanded="false" aria-controls="collapseForm"><?=$diller['adminpanel-modal-text-17']?></a>
                                            </div>
                                        </div>
                                </div>
                            </div>
                            <div class="collapse" id="fontAcc" data-parent="#accordion">
                                <div class="w-100 border pl-3 pr-3 mb-3">
                                    <form action="post.php?process=sub_navigations_post&status=font_settings" method="post" >
                                        <div class="row ">
                                            <div class="form-group col-md-12 text-center bg-white text-dark border-bottom mb-0 ">
                                                <h5> <?=$diller['adminpanel-form-text-1000']?></h5>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class="form-group col-md-12 mt-4">
                                                <label  for="nav_font" class="w-100"><?=$diller['adminpanel-form-text-1001']?></label>
                                                <select name="nav_font" class="form-control" id="nav_font" >
                                                    <?php foreach ($fontlar as $font) {?>
                                                        <option value="<?=$font['font_adi']?>" <?php if($font['font_adi'] == $ayar['nav_font'] ) { ?>selected<?php }?>><?=$font['font_adi']?></option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row border-top pt-3 bg-light pb-3 mt-3">
                                            <div class="col-md-12 text-right">
                                                ...
                                                <a class="btn  btn-secondary text-white" data-toggle="collapse" data-target="#fontAcc" aria-expanded="false" aria-controls="collapseForm"><?=$diller['adminpanel-modal-text-17']?></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="collapse" id="genelAcc" data-parent="#accordion">
                                <div class="w-100 border pl-3 pr-3 mb-3">
                                    <form action="post.php?process=sub_navigations_post&status=add" method="post" >
                                        <div class="row ">
                                            <div class="form-group col-md-12 text-center bg-white text-dark border-bottom mb-0 ">
                            ...
                            <div class="row ">
                                <div class="col-md-7 ">
                                    <?php if(isset($_GET['search'])  && $_GET['search']==!null ) {?>
                                        <h6><?=$diller['adminpanel-text-161']?> : <?=$navigasyonSql->rowCount()?></h6>
                                        <a href="pages.php?page=sub_navigations" class="btn btn-sm btn-info shadow"><?=$_GET['search']?> <i class="fa fa-times"></i></a>
                                    <?php }?>
                                </div>
                                <div class="col-md-5 text-right">
                                    <form method="GET" action="pages.php">
                                        <div class="input-group ">
                                            <input type="hidden" name="page" value="sub_navigations" >
                            ...
                            <div class="w-100  mb-2 ">
                                ...
                                <div class="table-responsive ">
                                    <table class="table table-hover mb-0  ">
                                        ...
                                        <?php foreach ($navigasyonSql as $menuRows) {

                                            $altmenuSayisi = $db->prepare("select * from navigasyon where ust_id=:ust_id ");
                                            ...
                                            <tr id="<?php echo $menuRows['id'] ?>" style="cursor: move">
                                                ...
                                                <td width="150" style="min-width: 150px">
                                                    <a href="pages.php?page=sub_navigations_links&parent=<?=$menuRows['id']?>" class="btn btn-sm alert-warning border border-warning text-dark  rounded">
                                                ...
                                                <td width="85">
                                                    <?php if($menuRows['durum'] == '0' ) {?>
                                                        <a class="btn btn-sm btn-outline-danger " href="pages.php?page=sub_navigations&status_update=<?=$menuRows['id']?><?=$searchPage?>">
                                                    ...
                                                    <?php if($menuRows['durum'] == '1' ) {?>
                                                        <a class="btn btn-sm btn-success " href="pages.php?page=sub_navigations&status_update=<?=$menuRows['id']?><?=$searchPage?>">
                                                            <div class="d-flex align-items-center">
                                                ...
                                                <td class="text-right" style="min-width: 100px">
                                                    ...
                                                    <a href="" data-href="post.php?process=sub_navigations_post&status=delete&no=<?=$menuRows['id']?>"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger "><i class="fa fa-trash" ></i></a>
                                                </td>
                                            </tr>
                                        <?php }?>
                                        </tbody>
                                    </table>
                                    <?php if($navigasyonSql->rowCount()<='0' ) {?>
                                        <div class="w-100  p-3 ">
...
<script type='text/javascript'>
    $(document).ready(function(){
        ...
        $('.duzenleAjax').click(function(){
            ...
            // AJAX request
            $.ajax({
                url: 'masterpiece.php?page=sub_navigations_edit',
                type: 'post',
                data: {postID: postID},
...
<script>
    ...
    $(function () {
        $('#fontAcc').on('shown.bs.collapse', function (e) {
            $('html,body').animate({
                    scrollTop: $('#fontAcc').offset().top - 80 },
                500);
        });
    });
    $(function () {
        $('#infoAcc').on('shown.bs.collapse', function (e) {
            $('html,body').animate({
                    scrollTop: $('#infoAcc').offset().top - 80 },
                500);
        });
    });
</script>
<?php if($_SESSION['collepse_status'] == 'fontAcc'  ) {?>
    <script>
        $('#fontAcc').addClass('show');
        $('html,body').animate({
                scrollTop: $('#fontAcc').offset().top - 80 },
            0);
    </script>
