...
<?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from blog_kat where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  border-bottom  pt-2 pb-2 mb-3">
                        <h4><?=$diller['adminpanel-form-text-1096']?></h4>
                    </div>
                    <form action="post.php?process=blog_post&status=blog_cat_edit" method="post" enctype="multipart/form-data">
