...
<?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from navigasyon where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  border-bottom  pt-2 pb-2 mb-3">
                        <h4><?=$diller['adminpanel-form-text-889']?></h4>
                    </div>
                    <form action="post.php?process=sub_navigations_post&status=submenu_edit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row ">
                            <div class="form-group col-md-12 mb-0">
                                ...
                                <select name="url_tur_edit" class="form-control rounded-0 " id="url_tur_edit" required style="height: 55px">
