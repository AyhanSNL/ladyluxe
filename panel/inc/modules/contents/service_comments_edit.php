    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    ...
                    <form action="post.php?process=services_post&status=comments_edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="comment_id" value="<?=$row['id']?>" >
                       <div class="row">
                           <div class="col-md-12">
                               <div class="row">
                                   <div class="form-group col-md-12">
                                       <label for="date"><?=$diller['adminpanel-form-text-1133']?></label>
                                       <br>
                                       <a href="<?=$ayar['site_url']?>hizmet/<?=$modulRow['seo_url']?>/" target="_blank" class="btn btn-light btn-sm border shadow-sm ">
