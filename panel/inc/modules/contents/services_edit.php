...
<?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from hizmet where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  border-bottom  pt-2 pb-2 mb-3">
                        <h4><?=$diller['adminpanel-form-text-1128']?></h4>
                    </div>
                    <form action="post.php?process=services_post&status=edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="ser_id" value="<?=$row['id']?>" >
                       <div class="border">
                           <ul class="nav nav-tabs bg-light pt-2" id="myTab" role="tablist">
                               ...
                               <li class="nav-item">
                                   <a class="nav-link saas" id="gorsel-tab" data-toggle="tab" href="#gorsel" role="tab"  aria-selected="true">
                                       <?=$diller['adminpanel-form-text-1127']?>
                                   </a>
                               </li>
                               <li class="nav-item">
                           ...
                           <div class="tab-content bg-white rounded-bottom">
                               <div class="tab-pane active p-4" id="one_e" role="tabpanel" >
                                   <div class="row">
                                       ...
                                       <div class="form-group col-md-8">
                                           <label for="baslik2">* <?=$diller['adminpanel-form-text-1131']?></label>
                                       ...
                                       <div class="form-group col-md-12">
                                           <label for="spot2"><?=$diller['adminpanel-form-text-1129']?></label>
                                           <textarea name="spot" id="spot2" class="form-control" rows="2" ><?=$row['spot']?></textarea>
                                       </div>
                                       <div class="form-group col-md-12 mb-0">
                                           <label for="icerik2">* <?=$diller['adminpanel-form-text-1130']?></label>
                               ...
                               <div class="tab-pane fade p-4" id="gorsel" role="tabpanel" >
                                   <div class="row">
                                       <div class="form-group col-md-12">
                                           <label for="inputGroupFile01_2"><?=$diller['adminpanel-form-text-1127']?> (600x320)  <small>( png,  jpg, jpeg, gif, svg )</small></label>
                                           <div class="w-100 bg-light border p-3">
                                               <div class="mx-auto" style=" text-align: center;">
                                                   <?php if($row['gorsel'] == !null ) {?>
                                                       <img class="img-fluid p-1 bg-white border" src="<?=$ayar['site_url']?>images/services/<?=$row['gorsel']?>" alt=""style="height: 160px">
                                                   <?php }else { ?>
