...
$fontlar->execute();
$sayfaSorgu = $db->prepare("select * from ebulten_ayar where id='1' ");
$sayfaSorgu->execute();
$detay = $sayfaSorgu->fetch(PDO::FETCH_ASSOC);


?>
<title><?=$diller['adminpanel-menu-text-141']?> - <?=$panelayar['baslik']?></title>
                    ...
                    <div class="row align-items-center d-flex justify-content-between" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=theme_enews"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-141']?></a>
                            </div>
                        </div>
                        <div class="col-md-auto mr-3" >
                            <?php if($yetki['icerik_yonetim'] == '1' && $yetki['blog_hizmet'] == '1' ) {?>
                                <div class="mt-2 d-md-none d-sm-block"></div>
                                <a href="pages.php?page=email_list"  class="btn btn-primary" style="font-size: 13px; font-weight: 400;"> <?=$diller['adminpanel-form-text-595']?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse in show" id="genelAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_enews_post&status=main_update" method="post">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="ebulten_border"><?=$diller['adminpanel-form-text-384']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['ebulten_border']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="ebulten_border"  value="" class="form-control">
                                            ...
                                            <div class="in-header-page-main mt-4" >
                                                <div class="in-header-page-text"><i class="fa fa-arrow-down"></i>
                                                    <?=$diller['adminpanel-form-text-596']?>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="form-group col-md-6">
                                                    <label for="input_bg"><?=$diller['adminpanel-form-text-597']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['input_bg']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="input_bg"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="input_border"><?=$diller['adminpanel-form-text-598']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['input_border']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="input_border"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="input_yazi_renk"><?=$diller['adminpanel-form-text-599']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['input_yazi_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="input_yazi_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="input_button_yazi"><?=$diller['adminpanel-form-text-600']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['input_button_yazi']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="input_button_yazi"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="otherAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_enews_post&status=bg_update" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="w-100 bg-light   p-3 text-center mb-3 ">
                                                                <?php if($detay['bg_image'] == !null  ) {?>
                                                                    ...
                                                                    <br><br>
                                                                    <a href="" data-href="post.php?process=theme_enews_post&status=bg_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-167']?></a>
                                                                <?php }else{ ?>
