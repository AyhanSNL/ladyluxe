...
$fontlar->execute();
$sayfaSorgu = $db->prepare("select * from blog_ayar where id='1' ");
$sayfaSorgu->execute();
$detay = $sayfaSorgu->fetch(PDO::FETCH_ASSOC);


?>
<title><?=$diller['adminpanel-menu-text-139']?> - <?=$panelayar['baslik']?></title>
                    ...
                    <div class="row align-items-center d-flex justify-content-between" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=theme_blogs"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-139']?></a>
                            </div>
                        </div>
                        <div class="col-md-auto mr-3" >
                            <?php if($yetki['icerik_yonetim'] == '1' && $yetki['blog_hizmet'] == '1' ) {?>
                                <div class="mt-2 d-md-none d-sm-block"></div>
                                <a href="pages.php?page=blogs"  class="btn btn-primary" style="font-size: 13px; font-weight: 400;"> <?=$diller['adminpanel-text-334']?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse in show" id="genelAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_blogs_post&status=main_update" method="post">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 mb-4">
                                                    <label for="blog_limit"> <?=$diller['adminpanel-form-text-585']?></label>
                                                    <input type="number" name="blog_limit" value="<?=$detay['blog_limit']?>" id="blog_limit" required class="form-control">
                                                </div>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="blogayar_border"><?=$diller['adminpanel-form-text-384']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['blogayar_border']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="blogayar_border"  value="" class="form-control">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select name="tumu_buton" class="form-control" id="tumu_buton" required>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label  for="blog_baslik_tip" class="w-100"><?=$diller['adminpanel-form-text-566']?></label>
                                                    <select name="blog_baslik_tip" class="form-control" id="blog_baslik_tip" >
                                                        <option value="0" <?php if($detay['blog_baslik_tip'] == '0'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-568']?></option>
                                                        <option value="1" <?php if($detay['blog_baslik_tip'] == '1'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-567']?></option>
                                                    </select>
                                                </div>
                                                <div id="line-header-text" class="w-100  " <?php if($detay['blog_baslik_tip'] == '0'  ) { ?>style="display:none<?php }?>">
                                                    <div class="row pl-3 pr-3">
                                                        <div class="form-group col-md-6">
                                                            <label for="blog_baslik_cizgi"><?=$diller['adminpanel-form-text-569']?></label>
                                                            <div data-color-format="default" data-color="#<?=$detay['blog_baslik_cizgi']?>"  class="colorpicker-default input-group">
                                                                <input type="text" name="blog_baslik_cizgi"  value="" class="form-control">
                                                                <div class="input-group-append add-on">
                                                                    <button class="btn btn-light border" type="button">
                                                                        <i style="background-color: rgb(124, 66, 84);"></i>
                                                                    </button>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="blog_baslik_bg"><?=$diller['adminpanel-form-text-570']?></label>
                                                            <div data-color-format="default" data-color="#<?=$detay['blog_baslik_bg']?>"  class="colorpicker-default input-group">
                                                                <input type="text" name="blog_baslik_bg"  value="" class="form-control">
                                                                <div class="input-group-append add-on">
                                                                    <button class="btn btn-light border" type="button">
                                                                        <i style="background-color: rgb(124, 66, 84);"></i>
                                                                    </button>
                                            ...
                                            <div class="in-header-page-main mt-4" >
                                                <div class="in-header-page-text">
                                                    <i class="fa fa-arrow-down"></i>
                                                    <?=$diller['adminpanel-form-text-586']?>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="form-group col-md-6">
                                                    <label for="kutu_bg"><?=$diller['adminpanel-form-text-264']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['kutu_bg']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="kutu_bg"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="kutu_baslik_renk"><?=$diller['adminpanel-form-text-588']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['kutu_baslik_renk']?>"  class="colorpicker-default input-group">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="kutu_spot_renk"><?=$diller['adminpanel-form-text-587']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['kutu_spot_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="kutu_spot_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="kutu_tarih_renk"><?=$diller['adminpanel-form-text-589']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['kutu_tarih_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="kutu_tarih_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="kutu_more_renk"><?=$diller['adminpanel-form-text-590']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['kutu_more_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="kutu_more_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                            ...
                                            <div class="in-header-page-main mt-4" >
                                                <div class="in-header-page-text">
                                                    <i class="fa fa-arrow-down"></i>
                                                    <?=$diller['adminpanel-text-311']?> <i class="ti-help-alt text-primary " data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-583']?>"></i>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="form-group col-md-12">
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="otherAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_blogs_post&status=bg_update" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="form-group col-md-12 ">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="w-100 bg-light   p-3 text-center mb-3 ">
                                                                <?php if($detay['bg_image'] == !null  ) {?>
                                                                    ...
                                                                    <br><br>
                                                                    <a href="" data-href="post.php?process=theme_blogs_post&status=bg_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-167']?></a>
                                                                <?php }else{ ?>
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="otherAcc2" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_blogs_post&status=detail_update" method="post">
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <label for="detay_bg_color"><?=$diller['adminpanel-form-text-576']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['detay_bg_color']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="detay_bg_color"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6 mb-4">
                                                    <label  for="okunma" class="w-100"><?=$diller['adminpanel-form-text-592']?></label>
                                                    <div class="custom-control custom-switch custom-switch-lg">
                                                        <input type="hidden" name="okunma" value="0"">
                                                        <input type="checkbox" class="custom-control-input" id="okunma" name="okunma" value="1" <?php if($detay['okunma'] == '1'  ) { ?>checked<?php }?> >
                                                        <label class="custom-control-label" for="okunma"></label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 mb-4">
                                                    <label  for="detay_kategoriler" class="w-100"><?=$diller['adminpanel-form-text-593']?></label>
                                                    <div class="custom-control custom-switch custom-switch-lg">
                                                        <input type="hidden" name="detay_kategoriler" value="0"">
                                                        <input type="checkbox" class="custom-control-input" id="detay_kategoriler" name="detay_kategoriler" value="1" <?php if($detay['detay_kategoriler'] == '1'  ) { ?>checked<?php }?> >
                                                        <label class="custom-control-label" for="detay_kategoriler"></label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 mb-4">
                                                    <label  for="detay_hits" class="w-100"><?=$diller['adminpanel-form-text-594']?></label>
                                                    <div class="custom-control custom-switch custom-switch-lg">
                                                        <input type="hidden" name="detay_hits" value="0"">
                                                        <input type="checkbox" class="custom-control-input" id="detay_hits" name="detay_hits" value="1" <?php if($detay['detay_hits'] == '1'  ) { ?>checked<?php }?> >
                                                        <label class="custom-control-label" for="detay_hits"></label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6 mb-4">
                                                    <label  for="list_kategoriler" class="w-100" > <?=$diller['adminpanel-form-text-591']?></label>
                                                    <div class="custom-control custom-switch custom-switch-lg">
                                                        <input type="hidden" name="list_kategoriler" value="0"">
                                                        <input type="checkbox" class="custom-control-input" id="list_kategoriler" name="list_kategoriler" value="1"  <?php if($detay['list_kategoriler'] == '1'  ) { ?>checked<?php }?> ">
                                                        <label class="custom-control-label" for="list_kategoriler"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
...
<script id="rendered-js" >
    ...
    $('#blog_baslik_tip').on('change', function() {
