...
$fontlar->execute();
$sayfaSorgu = $db->prepare("select * from tanitim_video where id='1' ");
$sayfaSorgu->execute();
$detay = $sayfaSorgu->fetch(PDO::FETCH_ASSOC);


?>
<title><?=$diller['adminpanel-menu-text-176']?> - <?=$panelayar['baslik']?></title>
                    ...
                    <div class="row align-items-center d-flex justify-content-between" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=theme_intro"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-176']?></a>
                            </div>
                        </div>
                        <div class="col-md-auto mr-3" >
                            <?php if($yetki['icerik_yonetim'] == '1' && $yetki['galeri'] == '1' ) {?>
                                <div class="mt-2 d-md-none d-sm-block"></div>
                                <a href="pages.php?page=intro"  class="btn btn-primary" style="font-size: 13px; font-weight: 400;"> <?=$diller['adminpanel-form-text-622']?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse in show" id="genelAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_intro_post&status=main_update" method="post">
                                            <div class="row">
                                            ...
                                            <div class="in-header-page-main mt-4" >
                                                <div class="in-header-page-text">
                                                    ...
                                                    <?=$diller['adminpanel-form-text-623']?>
                                                </div>
                                            </div>
                                            <div class="row mt-3 mb-3">
                                                <div class="form-group col-md-6">
                                                    <label for="button_renk"><?=$diller['adminpanel-form-text-624']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['button_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="button_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="button_hover_renk"><?=$diller['adminpanel-form-text-625']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['button_hover_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="button_hover_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="button_ani_renk"><?=$diller['adminpanel-form-text-626']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['button_ani_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="button_ani_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="button_play_renk"><?=$diller['adminpanel-form-text-627']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['button_play_renk']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="button_play_renk"  value="" class="form-control">
                                                        <div class="input-group-append add-on">
                                                            <button class="btn btn-light border" type="button">
                                                                <i style="background-color: rgb(124, 66, 84);"></i>
                                                            </button>
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="otherAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_intro_post&status=bg_update" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="w-100 bg-light   p-3 text-center mb-3 ">
                                                                <?php if($detay['bg_image'] == !null  ) {?>
                                                                    ...
                                                                    <br><br>
                                                                    <a href="" data-href="post.php?process=theme_intro_post&status=bg_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-167']?></a>
                                                                <?php }else{ ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <div class="w-100 p-3 text-center mb-2 " style="background-color: #<?=$detay['bg_color']?>;">
                                                            <?php if($detay['logo'] == !null  ) {?>
                                                                <small class="text-dark bg-white p-1">
                                                                    <?=$diller['adminpanel-text-151']?>
                                                                </small>
                                                                <br><br>
                                                                <img src="<?=$ayar['site_url']?>images/uploads/<?=$detay['logo']?>" class="img-fluid" >
                                                                <br><br>
                                                                <small class="bg-white p-1">
                                                                    <?=$diller['adminpanel-form-text-89']?> : 190x50
                                                                </small>
                                                                <br><br>
                                                                <a href="" data-href="post.php?process=theme_intro_post&status=logo_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-286']?></a>
                                                            <?php }else{ ?>
                                                                <img src="assets/images/no-img.jpg" style="width: 90px" class="border"  >
                                                                <br><br>
                                                                <small class="bg-white p-1">
                                                        ...
                                                        <div class="w-100 border-top pt-2 ">
                                                            <form action="post.php?process=theme_intro_post&status=logo" method="post" enctype="multipart/form-data">
                                                                <input type="hidden" name="old_logo" value="<?=$detay['logo']?>">
                                                                <div class="input-group mb-3">
                                                                    <div class="custom-file">
