...
$fontlar->execute();
$sayfaSorgu = $db->prepare("select * from vitrin_firsat where id='1' ");
$sayfaSorgu->execute();
$detay = $sayfaSorgu->fetch(PDO::FETCH_ASSOC);
?>
<title><?=$diller['adminpanel-text-306']?> - <?=$panelayar['baslik']?></title>
                    ...
                    <div class="row align-items-center d-flex justify-content-between" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=theme_showcase_countdown"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-text-306']?></a>
                            </div>
                        </div>
                        <div class="col-md-auto mr-3" >
                            <div class="mt-2 d-md-none d-sm-block"></div>
                            <?php if($yetki['modul'] == '1' && $yetki['modul_vitrin'] == '1' ) {?>
                                <a href="pages.php?page=showcase_countdown"  class="btn btn-primary" style="font-size: 13px; font-weight: 400;"> <?=$diller['adminpanel-text-329']?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse in show" id="genelAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_catalog_post&status=firsat_showcase" method="post">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="vitrin_limit"><?=$diller['adminpanel-form-text-395']?></label>
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="bgAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_catalog_post&status=firsat_showcase_bg" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="form-group col-md-12 ">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="w-100 bg-light   p-3 text-center mb-3 ">
                                                                <?php if($detay['bg_image'] == !null  ) {?>
                                                                    ...
                                                                    <br><br>
                                                                    <a href="" data-href="post.php?process=theme_catalog_post&status=firsat_showcase_bg_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-167']?></a>
                                                                <?php }else{ ?>
