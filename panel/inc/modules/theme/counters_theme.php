...
$fontlar->execute();
$sayfaSorgu = $db->prepare("select * from sayac_ayar where id='1' ");
$sayfaSorgu->execute();
$detay = $sayfaSorgu->fetch(PDO::FETCH_ASSOC);


?>
<title><?=$diller['adminpanel-menu-text-145']?> - <?=$panelayar['baslik']?></title>
                    ...
                    <div class="row align-items-center d-flex justify-content-between" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=theme_client_counter"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-145']?></a>
                            </div>
                        </div>
                        <div class="col-md-auto mr-3" >
                            <?php if($yetki['icerik_yonetim'] == '1' && $yetki['icerik_diger'] == '1' ) {?>
                                <div class="mt-2 d-md-none d-sm-block"></div>
                                <a href="pages.php?page=counters"  class="btn btn-primary" style="font-size: 13px; font-weight: 400;"> <?=$diller['adminpanel-form-text-610']?></a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse in show" id="genelAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_counters_post&status=main_update" method="post">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 mb-4">
                                                    <label  for="yazi_font" class="w-100"> <?=$diller['adminpanel-form-text-77']?></label>
                                                    <select name="yazi_font" class="form-control" id="yazi_font" >
                                                        <?php foreach ($fontlar as $font) {?>
                                                            <option value="<?=$font['font_adi']?>" <?php if($font['font_adi'] == $detay['yazi_font'] ) { ?>selected<?php }?>><?=$font['font_adi']?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6 mb-4">
                                                    <label for="sayacayar_border"><?=$diller['adminpanel-form-text-384']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['sayacayar_border']?>"  class="colorpicker-default input-group">
                                                        <input type="text" name="sayacayar_border"  value="" class="form-control">
                                            ...
                                            <div class="in-header-page-main mt-4" >
                                                <div class="in-header-page-text"><i class="fa fa-arrow-down"></i>
                                                    <?=$diller['adminpanel-form-text-614']?>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="form-group col-md-4">
                                                    <label for="yazi_renk"><?=$diller['adminpanel-form-text-612']?></label>
                                                    <div data-color-format="default" data-color="#<?=$detay['yazi_renk']?>"  class="colorpicker-default input-group">
                                                ...
                                                <div class="form-group col-md-4 mb-4">
                                                    <label  for="yazi_space" class="w-100"> <?=$diller['adminpanel-form-text-611']?></label>
                                                    <select name="yazi_space" class="form-control" id="yazi_space" >
                                                        <option value="" <?php if($detay['yazi_space'] == ''  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-401']?></option>
                                                        <option value="lspac" <?php if($detay['yazi_space'] == 'lspac'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-398']?></option>
                                                        <option value="lspacsmall" <?php if($detay['yazi_space'] == 'lspacsmall'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-399']?></option>
                                                        <option value="lspacsmall_2" <?php if($detay['yazi_space'] == 'lspacsmall_2'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-400']?></option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-4 mb-4">
                                                    <label  for="border" class="w-100" ><?=$diller['adminpanel-form-text-613']?></label>
                                                    <div class="custom-control custom-switch custom-switch-lg">
                                                        <input type="hidden" name="border" value="0"">
                                                        <input type="checkbox" class="custom-control-input" id="border" name="border" value="1"  <?php if($detay['border'] == '1'  ) { ?>checked<?php }?> ">
                                                        <label class="custom-control-label" for="border"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                        ...
                        <div class="card mb-2 " >
                            <div class="card-body">
                                ...
                                <div class="collapse" id="otherAcc" data-parent="#accordion">
                                    <div class="w-100 border-top pt-3">
                                        <form action="post.php?process=theme_counters_post&status=bg_update" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="w-100 bg-light   p-3 text-center mb-3 ">
                                                                <?php if($detay['bg_image'] == !null  ) {?>
                                                                    ...
                                                                    <br><br>
                                                                    <a href="" data-href="post.php?process=theme_counters_post&status=bg_delete"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger"><i class="ti-trash"></i> <?=$diller['adminpanel-text-167']?></a>
                                                                <?php }else{ ?>
