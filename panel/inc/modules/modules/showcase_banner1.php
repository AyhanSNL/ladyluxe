    ...
    if ($yetki['demo'] != '1') {
        ...
        foreach ($position as $idler) {
            ...
            try {
                ...
                $query = $db->query("UPDATE vitrin_tip2 SET sira = '$count' WHERE id = '$idler2'");
...
if ($yetki['demo'] != '1') {
    if ($_GET['status_update'] == !null) {
        ...
        $statusCek = $db->prepare("select * from vitrin_tip2 where id=:id ");
        ...
        if ($statusCek->rowCount() > '0') {
         ...
         ");
            ...
            if ($sonuc) {
                header('Location:' . $ayar['panel_url'] . 'pages.php?page=showcase_banner1' . $sayfa . '');
            } else {
...
?>
<title><?=$diller['adminpanel-menu-text-13']?> - <?=$panelayar['baslik']?></title>
...
<div class="wrapper" style="margin-top: 0;">
    <div class="container-fluid">
                    ...
                    <div class="row align-items-center" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=showcase_banner1"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-menu-text-13']?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php if($yetki['modul'] == '1' &&  $yetki['modul_diger'] == '1') {
            ...
            $Say = $db->query("select * from vitrin_tip2 where dil='$_SESSION[dil]'");
            $ToplamVeri = $Say->rowCount();
            $Limit = 25;
            $Sayfa_Sayisi = ceil($ToplamVeri/$Limit); if($Sayfa > $Sayfa_Sayisi){$Sayfa = 1;}
            $Goster = $Sayfa * $Limit - $Limit;
            $GorunenSayfa = 5;
            $islemListele = $db->query("select * from vitrin_tip2 where dil='$_SESSION[dil]'  order by sira ASC limit $Goster,$Limit");
                    ...
                    <div class="card p-3">
                        <div class="new-buttonu-main-top">
                            <div class="new-buttonu-main-left">
                                <h4> <?=$diller['adminpanel-menu-text-13']?></h4>
                            </div>
                            <div class="new-buttonu-main">
                                <a  class="btn btn-info text-white " href="pages.php?page=theme_showcase_banner1"><?=$diller['adminpanel-form-text-838']?></a>
                        ...
                        <div id="accordion" class="accordion">
                            <div class="collapse " id="genelAcc" data-parent="#accordion">
                                <div class="w-100 border pl-3 pr-3 mb-3">
                                    <form action="post.php?process=showcase_post&status=banner1_add" method="post" enctype="multipart/form-data" >
                                        <div class="row ">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="spot"><?=$diller['adminpanel-form-text-969']?></label>
                                                <textarea name="spot" id="spot" class="form-control" rows="2" ></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="adres_url"><?=$diller['adminpanel-form-text-908']?></label>
                                            ...
                                            <div class="form-group col-md-12 mb-4">
                                                <label  for="yazi_durum" class="w-100"><?=$diller['adminpanel-form-text-971']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="yazi_durum" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="yazi_durum" name="yazi_durum" value="1"  onclick="actionBox(this.checked);">
                                                    <label class="custom-control-label" for="yazi_durum"></label>
                                                </div>
                                            </div>
                                            <div id="actionBox" class="w-100 col-md-12  " style="display:none !important;" >
                                                   <div class="col-md-12 bg-light border p-3 pt-4 rounded">
                                                       <div class="row ">
                                                           ...
                                                           <div class="form-group col-md-6 mb-4">
                                                               <label  for="dark" class="w-100" ><?=$diller['adminpanel-form-text-972']?></label>
                                                               <div class="custom-control custom-switch custom-switch-lg">
                                                                   <input type="hidden" name="dark" value="0"">
                                                                   <input type="checkbox" class="custom-control-input" id="dark" name="dark" value="1"  checked">
                        ...
                        <div class="w-100">
                            ...
                            <div class="row row_position">
                                <?php foreach ($islemCek as $row) {?>
                                    <div class="<?=$row['col_md']?>" id="<?php echo $row['id'] ?>" style="cursor: move">
                                            ...
                                            <div class="card-body">
                                               <div class="d-flex align-items-center justify-content-center  " >
                                                ...
                                                <div class="text-center bg-light pt-2 pb-2">
                                                    <?php if($row['durum'] == '0' ) {?>
                                                        <a class="btn btn-sm btn-outline-danger " href="pages.php?page=showcase_banner1&status_update=<?=$row['id']?><?=$sayfa?>">
                                                    ...
                                                    <?php }?>
                                                    <?php if($row['durum'] == '1' ) {?>
                                                        <a class="btn btn-sm btn-success " href="pages.php?page=showcase_banner1&status_update=<?=$row['id']?><?=$sayfa?>">
                                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="" data-href="post.php?process=showcase_post&status=banner1_delete&no=<?=$row['id']?>"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger "><i class="fa fa-trash" ></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="SayfalamaElementi" class="w-100 p-2  border-bottom bg-light border-top  ">
                                ...
                                <nav aria-label="Page navigation example " >
                                    <ul class="pagination pagination-sm justify-content-end mb-0 ">
                                        <?php } ?>
                                        <?php if($Sayfa > 1){  ?>
                                            <li class="page-item "><a class="page-link " href="pages.php?page=showcase_banner1"><?=$diller['sayfalama-ilk']?></a></li>
                                            <li class="page-item "><a class="page-link " href="pages.php?page=showcase_banner1&p=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                                        <?php } ?>
                                        <?php
                                        for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                                            if($i == $Sayfa){
                                                ...
                                                <li class="page-item active " aria-current="page">
                                                    <a class="page-link" href="pages.php?page=showcase_banner1&p=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>
                                                </li>
                                                <?php
                                            }else{
                                                ?>
                                                <li class="page-item "><a class="page-link" href="pages.php?page=showcase_banner1&p=<?=$i?>"><?=$i?></a></li>
                                                <?php
                                            }
                                        }
                                        }
                                        ...
                                        <?php if($islemListele->rowCount() <=0) { } else { ?>
                                            <?php if($Sayfa != $Sayfa_Sayisi){?>
                                                <li class="page-item"><a class="page-link" href="pages.php?page=showcase_banner1&p=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                                                <li class="page-item"><a class="page-link" href="pages.php?page=showcase_banner1&p=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                                            <?php }} ?>
                                        <?php if($Sayfa >= 1){?>
                                    </ul>
                                </nav>
...
<script type='text/javascript'>
    $(document).ready(function(){
        ...
        $('.duzenleAjax').click(function(){
            ...
            // AJAX request
            $.ajax({
                url: 'masterpiece.php?page=showcase_banner1_edit',
                type: 'post',
                data: {postID: postID},
