...
<?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from vitrin_tip3 where id='$_POST[postID]' ");
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    ...
                    <form action="post.php?process=showcase_post&status=banner2_edit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card border mb-1">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="baslik_color"><?=$diller['adminpanel-form-text-978']?></label>
                                                <div data-color-format="default" data-color="#<?=$row['baslik_color']?>"  class="colorpicker-default input-group">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="adres_url2"><?=$diller['adminpanel-form-text-977']?></label>
