                    ...
                    <form action="post.php?process=ty_post&status=ty_urun_cek" method="post" id="commentForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <small>Sunucuyu yormamak adına gereklidir.</small>
                                <input type="number" min="1" max="100" class="form-control" id="sayfa"   name="sayfa" required>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="cek_limit" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                    Sayfa'dan Çekilecek Ürün Limiti
                                </label>
