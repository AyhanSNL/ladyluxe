            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  pt-2 pb-0 border-bottom mb-3">
                        <h6><?= $diller['pazaryeri-text-102'] ?>(Hepsiburada)</h6>
                    </div>
                    <div class="w-100 bg-light mb-3 border p-3">
                        <?=$diller['pazaryeri-text-166']?>
                    </div>
                    <form action="post.php?process=hb_post&status=hb_toplu_urun_gonder" method="post" id="commentForm">
