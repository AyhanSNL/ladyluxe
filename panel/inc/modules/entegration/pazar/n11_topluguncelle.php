            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  pt-2 pb-0 border-bottom mb-3">
                        <h6><?= $diller['pazaryeri-text-59'] ?></h6>
                    </div>
                    <form action="post.php?process=pazar_post&status=n11_toplurunguncelle" method="post" id="commentForm">
                        <input type="hidden" name="process_id" value="<?= $_POST['postID'] ?>">
                        <div class="row">
                                ...
                                <div class="border bg-light rounded p-3 up-arrow-2">
                                    <div class="row">
                                        <div class="form-group col-md-12 mb-0">
                                            <div class="form-group col-md-12 ">
                                                <label for="ek_tur" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                                   <?=$diller['pazaryeri-text-68']?>
                                                </label>
                                                <select name="ek_tur" class="form-control" id="ek_tur" required>
                                                    <option value="1"><?=$diller['pazaryeri-text-71']?></option>
                                                    <option value="2"><?=$diller['pazaryeri-text-69']?></option>
                                                    <option value="3"><?=$diller['pazaryeri-text-70']?></option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-12 ">
                                                <label for="ek_oran" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                                    <?=$diller['adminpanel-form-text-1216']?>
                                                </label>
