                ...
                <div class="row">
                            ...
                            <div class="sitemap-div-main p-0">
                                <div class="sitemap-link-main">
                                    ...
                                    <div class="sitemap-link-address">
                                        <a href="<?=$ayar['panel_url'] ?>inc/input/gsm/<?=$row['dosya']?>" target="_blank">
                                            <?=$ayar['panel_url'] ?>inc/input/gsm/<?=$row['dosya']?>
                                        </a>
                                    </div>
                                    <a class="sitemap-link-refresh" href="<?=$ayar['panel_url'] ?>inc/input/gsm/<?=$row['dosya']?>" target="_blank">
                    ...
                    <div class="col-md-12">
                        <div class="card p-3">
                            ...
                            <form action="pages.php?page=gsm_list_import_process_step&id=<?=$row['id']?>" method="post">
                                ...
                                <div class="row d-flex align-items-center justify-content-center ">
                                    <div class="form-group col-md-4">
                                        <label for="ana_etiket" class="d-flex align-items-center justify-content-start">
                                            <?=$diller['adminpanel-form-text-2079']?>
                                            <i class="ti-help-alt text-primary ml-1 " data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-2080']?>"></i>
                                        </label>
                                ...
                                <div class="row d-flex align-items-center justify-content-center ">
                                    <div class="form-group col-md-4">
                                        <label for="no_etiket" class="d-flex align-items-center justify-content-start">
                                            <?=$diller['adminpanel-form-text-2081']?>
                                            <i class="ti-help-alt text-primary ml-1 " data-toggle="tooltip" data-placement="top" title="<?=$diller['adminpanel-form-text-2082']?>"></i>
                                        </label>
                                        <input type="text" name="no_etiket" autocomplete="off"  id="no_etiket" required class="form-control">
                                    </div>
                                </div>
                                <div class="row d-flex align-items-center justify-content-center ">
                                    <div class="form-group col-md-4">
                                        <label for="isim_etiket" class="d-flex align-items-center justify-content-start">
                                            <?=$diller['adminpanel-form-text-2083']?>
                                        </label>
                                        <input type="text" name="isim_etiket" autocomplete="off"  id="isim_etiket"  class="form-control">
                                    </div>
                                </div>
                                <div class="row d-flex align-items-center justify-content-center ">
                                    <div class="form-group col-md-4">
