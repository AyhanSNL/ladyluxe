<?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from ulkeler where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  border-bottom  pt-2 pb-2 mb-3">
                        <h4><?=$diller['adminpanel-form-text-720']?></h4>
                    </div>
                    <form action="post.php?process=countries_post&status=edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="ulke_id" value="<?=$row['id']?>" >
                        <div class="row ">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="countries_select2 form-control col-md-12" name="3_iso"  id="3_iso" style="width: 100%!important;" >
                                    <option value="<?=$row['3_iso']?>"><?=$row['3_iso']?></option>
