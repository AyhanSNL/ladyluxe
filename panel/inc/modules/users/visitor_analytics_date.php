...
if(isset($_GET['show']) && $_GET['show'] == !null  ) {
    if($_GET['show']!= 'mobile' && $_GET['show'] != 'desktop'  ) {
        header('Location:' . $ayar['panel_url'] . 'pages.php?page=visitor_analytics_date');
        exit();
    }
}
if (isset($_GET['show']) && $_GET['show'] == !null) {
                    ...
                    <div class="card">
                        <div class="card-body ">
                            ...
                            <ul class="nav nav-tabs  pt-2" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link saas active" href="pages.php?page=visitor_analytics_date">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="border bg-light">
                                                <div class="card-body">
                                                    <form action="pages.php" method="get">
                                                        <input type="hidden" name="page" value="visitor_analytics_date" >
                                                    <div class="row">
                                                    ...
                                                    <div class=" bg-light " >
                                                        <div class="card-body text-center" style="font-size: 14px ; ">
                                                           <strong><?php echo date_tr('j F Y', ''.$_GET['date'].''); ?></strong>
                                                            ...
                                                            <?=$diller['adminpanel-form-text-1427']?>
                                                        </div>
                                                    </div>
                                                    <a href="pages.php?page=visitor_analytics_date" class="btn btn-pink btn-block" style="border-radius: 0 0 4px 4px">
                                        ...
                                        <?php if(isset($_GET['date']) && isset($_GET['date_end'])) {
                                            ...
                                            if(isset($_GET['show']) && $_GET['show'] == 'desktop' ) {
                                                $deviceFilter = "and cihaz='desktop'";
                                            }
                                            if(isset($_GET['show']) && $_GET['show'] == 'mobile' ) {
                                                $deviceFilter = "and cihaz='mobile'";
                                            }

                                            $Sayfa = @intval($_GET['p']); if(!$Sayfa) $Sayfa = 1;
                                            $Say = $db->query("select * from ziyaretciler $minDate $maxDate $deviceFilter ");
                                            $ToplamVeri = $Say->rowCount();
                                            $Limit = 50;
                                            $Sayfa_Sayisi = ceil($ToplamVeri/$Limit); if($Sayfa > $Sayfa_Sayisi){$Sayfa = 1;}
                                            $Goster = $Sayfa * $Limit - $Limit;
                                            $GorunenSayfa = 5;
                                            $islemListele = $db->query("select * from ziyaretciler $minDate $maxDate $deviceFilter order by tarih desc limit $Goster,$Limit");
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <?php if(isset($_GET['show']) && $_GET['show'] == 'desktop'  ) {?>
                                                        <a href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$sayfa?>" class="btn btn-primary btn-sm " style="border-radius: 0"><i class="fa fa-times"></i> <?=$diller['adminpanel-form-text-1429']?></a>
                                                    <?php }else { ?>
                                                        <a href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$sayfa?>&show=desktop" class="btn btn-outline-primary btn-sm " style="border-radius: 0"><?=$diller['adminpanel-form-text-1429']?></a>
                                                    <?php }?>
                                                    <?php if(isset($_GET['show']) && $_GET['show'] == 'mobile'  ) {?>
                                                    <a href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$sayfa?>" class="btn btn-success btn-sm " style="border-radius: 0"><i class="fa fa-times"></i> <?=$diller['adminpanel-form-text-1428']?></a>
                                                    <?php }else { ?>
                                                    <a href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$sayfa?>&show=mobile" class="btn btn-outline-success btn-sm " style="border-radius: 0"><?=$diller['adminpanel-form-text-1428']?></a>
                                                    <?php }?>
                                                </div>
                                                <div class="table-responsive">
                                                    <table class="table table-hover text-left mb-0 ">
                                                        ...
                                                        <tr>
                                                            <th><?=$diller['adminpanel-form-text-1314']?></th>
                                                    ...
                                                    <div id="SayfalamaElementi" class="w-100 p-2  border-bottom bg-light  ">
                                                        ...
                                                        <nav aria-label="Page navigation example " >
                                                            <ul class="pagination pagination-sm justify-content-end mb-0 ">
                                                                <?php } ?>
                                                                <?php if($Sayfa > 1){  ?>
                                                                    <li class="page-item "><a class="page-link " href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>"><?=$diller['sayfalama-ilk']?></a></li>
                                                                    <li class="page-item "><a class="page-link " href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>&p=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                                                                <?php } ?>
                                                                <?php
                                                                for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                                                                    if($i == $Sayfa){
                                                                        ...
                                                                        <li class="page-item active " aria-current="page">
                                                                            <a class="page-link" href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>&p=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>
                                                                        </li>
                                                                        <?php
                                                                    }else{
                                                                        ?>
                                                                        <li class="page-item "><a class="page-link" href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>&p=<?=$i?>"><?=$i?></a></li>
                                                                        <?php
                                                                    }
                                                                }
                                                                }
                                                                ...
                                                                <?php if($islemListele->rowCount() <=0) { } else { ?>
                                                                    <?php if($Sayfa != $Sayfa_Sayisi){?>
                                                                        <li class="page-item"><a class="page-link" href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>&p=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                                                                        <li class="page-item"><a class="page-link" href="pages.php?page=visitor_analytics_date<?=$datePage?><?=$showPage?>&p=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                                                                    <?php }} ?>
                                                                <?php if($Sayfa >= 1){?>
                                                            </ul>
                                                        </nav>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class=" bg-light ">
                                                <div class="card-body">
                                                   <i class="fa fa-info-circle"></i> <?=$diller['adminpanel-form-text-1368']?>
                                                </div>
                                            </div>
                                        </div>
                                        <?php }?>
