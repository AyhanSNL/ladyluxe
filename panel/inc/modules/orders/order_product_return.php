...
if (isset($_GET['orderNO']) || isset($_GET['limit']) || isset($_GET['requestStatus']) || isset($_GET['orderType']) || isset($_GET['date']) || isset($_GET['date_end']) || isset($_GET['min']) || isset($_GET['max']) || isset($_GET['sort']) || isset($_GET['userID'])) {
    $filterPage = "&limit=$_GET[limit]&orderNO=$_GET[orderNO]&requestStatus=$_GET[requestStatus]&orderType=$_GET[orderType]&date=$_GET[date]&date_end=$_GET[date_end]&min=$_GET[min]&max=$_GET[max]&sort=$_GET[sort]&userID=$_GET[userID]";
}
...
?>
<title><?=$diller['adminpanel-menu-text-21']?> - <?=$panelayar['baslik']?></title>
<style>
    .ssa:before{
        display: none;
    }
...
<div class="wrapper" style="margin-top: 0;">
    <div class="container-fluid">
        ...
        <?php if($yetki['siparis'] == '1' && $yetki['siparis_yonet'] == '1') {
            ...
            if(isset($_GET['requestNO']) && $_GET['requestNO'] >'0'  ) {
                $talepNOGet = "and talep_no='$_GET[requestNO]'";
            }else{
                $talepNOGet = null;
            }

            if(isset($_GET['requestStatus'])   ) {
                if($_GET['requestStatus'] <= '0'  ) {
                    $statuGet = "and durum='0'";
                }else{
                    $statuGet = "and durum='$_GET[requestStatus]'";
                }
            }else{
                $statuGet = null;
            }
            ...
            $Say = $db->query("select * from 	siparis_urunler_iade $search $orderNOGet $talepNOGet $uyeGet $statuGet  ");
            $ToplamVeri = $Say->rowCount();
            $Limit = $limitGet;
            $Sayfa_Sayisi = ceil($ToplamVeri/$Limit); if($Sayfa > $Sayfa_Sayisi){$Sayfa = 1;}
            $Goster = $Sayfa * $Limit - $Limit;
            $GorunenSayfa = 5;
            $islemListele = $db->query("select * from siparis_urunler_iade $search $orderNOGet $talepNOGet $uyeGet $statuGet order by id desc limit $Goster,$Limit");
                    ...
                    <div class="card p-3">
                        <div class="new-buttonu-main-top mb-0 border-bottom pb-2 ">
                            <div class="new-buttonu-main-left">
                                <h4> <?=$diller['adminpanel-menu-text-21']?></h4>
                        ...
                        <div id="accordion" class="accordion">
                            <div class="collapse <?php if (isset($_GET['search']) || isset($_GET['orderNO']) || isset($_GET['orderStatus']) || isset($_GET['orderType']) || isset($_GET['date']) || isset($_GET['date_end']) || isset($_GET['min']) || isset($_GET['max']) || isset($_GET['sort']) ) {?>show<?php } ?>" id="filterAcc" data-parent="#accordion">
                                <form method="GET" action="pages.php">
                                    <input type="hidden" name="page" value="order_product_return" >
                                    <div class="p-3  border border-top-0" style="padding-bottom: 0!important;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label for="requestNO" class="d-flex align-items-center justify-content-start">
                                                    <?=$diller['adminpanel-form-text-1471']?>
                                                </label>
                                                <input type="text" name="requestNO" autocomplete="off" <?php if($_GET['requestNO'] >'0'  ) { ?>value="<?=$_GET['requestNO']?>" <?php }?> id="requestNO"  class="form-control" >
                                            </div>
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="requestStatus" class="form-control" id="requestStatus" >
                                                    ...
                                                    <option value="0" <?php if($_GET['requestStatus'] == '0'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-1567']?></option>
                                                    <option value="1" <?php if($_GET['requestStatus'] == '1'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-1569']?></option>
                                                    <option value="2" <?php if($_GET['requestStatus'] == '2'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-1570']?></option>
                                                    <option value="3" <?php if($_GET['requestStatus'] == '3'  ) { ?>selected<?php }?>><?=$diller['adminpanel-form-text-1571']?></option>
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <?php if (isset($_GET['search']) || isset($_GET['orderNO']) || isset($_POST['orderStatus']) || isset($_POST['orderType']) || isset($_POST['date']) || isset($_POST['date_end']) || isset($_POST['min']) || isset($_POST['max']) || isset($_POST['sort']) || isset($_POST['userID'])) {?>
                                                    <a class="btn  m-1 btn-danger text-white" href="pages.php?page=order_product_return" style="width: 150px">
                            ...
                            <?php if(isset($_GET['userID']) && $_GET['userID'] >'0' ) {
                                ...
                                <?php if($uyeCeh->rowCount()>'0'  ) {
                                    ...
                                    <div class="w-100  bg-secondary p-3 mb-2 text-white rounded mt-2" style="font-size: 16px ;">
                                        <i class="fa fa-user"></i>  <?=$uyeRo['isim']?> <?=$uyeRo['soyisim']?> <?=$diller['adminpanel-menu-text-21']?>
                                    </div>
                                <?php }?>
                            <?php }?>
                            ...
                            <div class="table-responsive ">
                                <table class="table table-bordered table-hover mb-0  ">
                                    ...
                                    <?php foreach ($islemCek as $row) {
                                        $urunCek = $db->prepare("select urun_baslik,urun_id from siparis_urunler where id=:id ");
                                        ...
                                        <tr>
                                            ...
                                            <td style="min-width: 125px" >
                                                <a href="pages.php?page=product_detail&productID=<?=$urun['urun_id']?>" target="_blank">
                                                    <?=$urun['urun_baslik']?>
                                                </a>
                                            </td>
                                            ...
                                            <?php if($row['durum'] == '0' ) {?>
                                                <div class="btn btn-sm btn-block btn-info  "  >
                                                    <div class="d-flex align-items-center justify-content-center " style="font-size: 11px !important; ;">
                                                        ...
                                                        <?=$diller['adminpanel-form-text-1567']?>
                                                    </div>
                                                </div>
                                            <?php }?>
                                                <?php if($row['durum'] == '1' ) {?>
                                                    <div class="btn btn-sm btn-block btn-primary  "  >
                                                        <div class="d-flex align-items-center justify-content-center " style="font-size: 11px !important; ;">
                                                            ...
                                                            <?=$diller['adminpanel-form-text-1569']?>
                                                        </div>
                                                    </div>
                                                <?php }?>
                                                <?php if($row['durum'] == '2' ) {?>
                                                    <div class="btn btn-sm btn-block btn-success  "  >
                                                        <div class="d-flex align-items-center justify-content-center " style="font-size: 11px !important; ;">
                                                          <i class="fa fa-check mr-2"></i>
                                                            <?=$diller['adminpanel-form-text-1570']?>
                                                        </div>
                                                    </div>
                                                <?php }?>
                                                <?php if($row['durum'] == '3' ) {?>
                                                    <div class="btn btn-sm btn-block btn-danger  "  >
                                                        <div class="d-flex align-items-center justify-content-center " style="font-size: 11px !important; ;">
                                                            ...
                                                            <?=$diller['adminpanel-form-text-1571']?>
                                                        </div>
                                                    </div>
                                                <?php }?>
                                            </td>
                                            <td class="text-center" width="170" style="min-width: 170px">
                                                <a href="pages.php?page=product_return&no=<?=$row['talep_no']?>" class="btn btn-sm btn-dark " ><i class="fa fa-edit"></i> <?=$diller['adminpanel-form-text-1470']?></a>
                                                <a href="" data-href="post.php?process=order_post&status=return_delete&no=<?=$row['talep_no']?>"  data-toggle="modal" data-target="#confirm-delete"  class="btn btn-sm btn-danger "><i class="fa fa-trash" ></i></a>
                                            </td>
                                        </tr>
                                    <?php }?>
                                    </tbody>
                                ...
                                <div id="SayfalamaElementi" class="w-100 p-2  border-bottom bg-light  ">
                                    ...
                                    <nav aria-label="Page navigation example " >
                                        <ul class="pagination pagination-sm justify-content-end mb-0 ">
                                            <?php } ?>
                                            <?php if($Sayfa > 1){  ?>
                                                <li class="page-item "><a class="page-link " href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>"><?=$diller['sayfalama-ilk']?></a></li>
                                                <li class="page-item "><a class="page-link " href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>&p=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                                            <?php } ?>
                                            <?php
                                            for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                                                if($i == $Sayfa){
                                                    ...
                                                    <li class="page-item active " aria-current="page">
                                                        <a class="page-link" href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>&p=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>
                                                    </li>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <li class="page-item "><a class="page-link" href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>&p=<?=$i?>"><?=$i?></a></li>
                                                    <?php
                                                }
                                            }
                                            }
                                            ...
                                            <?php if($islemListele->rowCount() <=0) { } else { ?>
                                                <?php if($Sayfa != $Sayfa_Sayisi){?>
                                                    <li class="page-item"><a class="page-link" href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>&p=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                                                    <li class="page-item"><a class="page-link" href="pages.php?page=order_product_return<?=$searchPage?><?=$filterPage?>&p=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                                                <?php }} ?>
                                            <?php if($Sayfa >= 1){?>
                                        </ul>
                                    </nav>
...
<script>
    ...
    $(document).ready(function() {
        $('.user_select_form').select2({
            ...
            placeholder: ' <?=$diller['adminpanel-form-text-1565']?>',
            ajax: {
