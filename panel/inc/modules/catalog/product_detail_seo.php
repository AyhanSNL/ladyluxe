                                        ...
                                        <div class="tab-pane active p-3" id="one" role="tabpanel" >
                                            <form action="post.php?process=catalog_post&status=product_post" method="post" >
                                                ...
                                                <div class="row p-3">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="form-group col-md-6  ">
                                                                        <label for="seo_baslik" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                                                            <?=$diller['adminpanel-form-text-1015']?>
                                                                        </label>
                                                                        <input type="text" name="seo_baslik" value="<?=$row['seo_baslik']?>" id="seo_baslik" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-6  ">
                                                                        <label for="seo_url" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                                                            <?=$diller['adminpanel-form-text-1756']?>
                                                                        </label>
                                                                        <input type="text" name="seo_url" value="<?=$row['seo_url']?>" id="seo_url" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-12  ">
                                                                        <label  for="etiketler" class="w-100"><?=$diller['adminpanel-form-text-6']?> </label>
                                                                        <input type="text" name="tags" value="<?=$row['tags']?>"  id="etiketler" data-role="tagsinput" placeholder="<?=$diller['adminpanel-form-text-7']?>" class="form-control" />
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-12  ">
                                                                        <label for="meta_desc" class="w-100 d-flex align-items-center justify-content-between flex-wrap">
                                                                            <?=$diller['adminpanel-form-text-5']?>
                                                                        </label>
                                                                        <textarea name="meta_desc" id="meta_desc" class="form-control" rows="2" ><?=$row['meta_desc']?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <button class="btn  btn-success btn-block buttonTextStyle "  name="meta_update">
