<?php echo !defined("GUVENLIK") ? die("Vaoww! Bu ne cesaret?") : null;?><?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from urun_ozellik_grup where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  pt-2 pb-2">
                        <h4><?=$diller['adminpanel-form-text-1860']?></h4>
                    </div>
                    <form action="post.php?process=catalog_post2&status=feature_group_edit" method="post">
                                ...
                                <div class="tab-pane active p-4" id="one_e" role="tabpanel" >
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="baslik2">* <?=$diller['adminpanel-form-text-1858']?></label>
