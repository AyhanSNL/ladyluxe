<?php echo !defined("GUVENLIK") ? die("Vaoww! Bu ne cesaret?") : null;?><?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from urun_cat where id='$_POST[postID]' ");
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
            ...
            <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                ...
                <form action="post.php?process=catalog_post2&status=sub_category_edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="w-100 pt-2 mt-2 d-flex justify-content-end">
                        <button class="btn btn-success btn-block  shadow-sm" name="subcatEdit">
