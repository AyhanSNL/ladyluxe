<?php echo !defined("GUVENLIK") ? die("Vaoww! Bu ne cesaret?") : null;?><?php if($_POST['postID']  ) {
    ...
    $queryControl = $db->prepare("select * from urun_ozellik where id='$_POST[postID]' ");
            ...
            <div class="modal-content" style="box-shadow: 0 0 10px 0 rgba(0,0,0,.3); border:1px solid #ccc">
                ...
                <div class="modal-body  pt-1 pl-4 pr-4 pb-4">
                    <div class="w-100  pt-2 pb-2">
                        <h4><?=$diller['adminpanel-form-text-1863']?></h4>
                    </div>
                    <form action="post.php?process=catalog_post2&status=feature_edit" method="post">
                        <input type="hidden" name="list_id" value="<?=$row['id']?>" >
                        <input type="hidden" name="group_id" value="<?=$row['grup_id']?>" >
                        <div class="border">
                                ...
                                <div class="tab-pane active p-4" id="one_e" role="tabpanel" >
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 mb-0">
                                            <label for="baslik2">* <?=$diller['adminpanel-form-text-1862']?></label>
