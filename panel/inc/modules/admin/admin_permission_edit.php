...
$sorgula = $db->prepare("select * from yetki_grup where id=:id ");
...
?>
<title><?=$diller['adminpanel-text-238']?> - <?=$panelayar['baslik']?></title>
<style>
                    ...
                    <div class="row align-items-center" >
                        <div class="col-md-8" >
                            <div class="page-title-nav">
                                ...
                                <a href="pages.php?page=permission_edit&no=<?=$_GET['no']?>"><i class="fa fa-angle-right"></i> <?=$diller['adminpanel-text-238']?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php if($yetki['site_ayarlar'] == '1' &&  $yetki['yonetici'] == '1') {?>
            ...
            <div class="row">
                ...
                <div class="<?php if($panelayar['panel_nav'] == '1'   ) { ?>col-md-9<?php }else{?>col-md-12<?php } ?>">
                        <div class="card p-4">
                        <form method="post" action="post.php?process=permission_post&status=per_edit">
                            <input type="hidden" name="per_id" value="<?=$row['id']?>">
                            <div class="w-100">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-9">
                                        ...
                                        <input type="text" name="baslik" id="baslik" value="<?=$row['baslik']?>" required class="form-control " autocomplete="off">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label  for="sira" class="w-100">* <?=$diller['adminpanel-form-text-55']?> </label>
                                        <input type="number" name="sira" id="sira" value="<?=$row['sira']?>" required class="form-control " autocomplete="off">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="demo" name="demo" value="1" <?php if($row['demo'] == '1'  ) { ?>checked<?php }?>>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="site_ayarlar" name="site_ayarlar" value="1"  <?php if($row['site_ayarlar'] == '1'  ) { ?>checked<?php }?> onclick="ayarlar(this.checked);">
                                            <label class="custom-control-label" for="site_ayarlar"></label>
                                        </div>
                                    </div>
                                    <div id="ayarlar" class="w-100"  <?php if($row['site_ayarlar'] == '0'  ) { ?>style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="ayar_yonet" class="w-100" ><?=$diller['adminpanel-text-175']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="ayar_yonet" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="ayar_yonet" name="ayar_yonet" value="1" <?php if($row['ayar_yonet'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="yonetici" name="yonetici" value="1" <?php if($row['yonetici'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="dil_yonet" name="dil_yonet" value="1" <?php if($row['dil_yonet'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="ayar_diger" name="ayar_diger" value="1" <?php if($row['ayar_diger'] == '1'  ) { ?>checked<?php }?>>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="katalog" name="katalog" value="1"  <?php if($row['katalog'] == '1'  ) { ?>checked<?php }?> onclick="katalogs(this.checked);">
                                            <label class="custom-control-label" for="katalog"></label>
                                        </div>
                                    </div>
                                    <div id="katalogs" class="w-100" <?php if($row['katalog'] == '0'  ) { ?>style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="urun" class="w-100" ><?=$diller['adminpanel-text-192']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="urun" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="urun" name="urun" value="1" <?php if($row['urun'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="kat" name="kat" value="1" <?php if($row['kat'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="marka" name="marka" value="1" <?php if($row['marka'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="varyant" name="varyant" value="1" <?php if($row['varyant'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="urun_yorum" name="urun_yorum" value="1" <?php if($row['urun_yorum'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="toplu" name="toplu" value="1" <?php if($row['toplu'] == '1'  ) { ?>checked<?php }?> >
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="siparis" name="siparis" value="1"  <?php if($row['siparis'] == '1'  ) { ?>checked<?php }?> onclick="orders(this.checked);">
                                            <label class="custom-control-label" for="siparis"></label>
                                        </div>
                                    </div>
                                    <div id="orders" class="w-100" <?php if($row['siparis'] == '0'  ) { ?>style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="siparis_yonet" class="w-100" ><?=$diller['adminpanel-text-201']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="siparis_yonet" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="siparis_yonet" name="siparis_yonet" value="1" <?php if($row['siparis_yonet'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="odeme_bildirim" name="odeme_bildirim" value="1" <?php if($row['odeme_bildirim'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="siparis_diger" name="siparis_diger" value="1" <?php if($row['siparis_diger'] == '1'  ) { ?>checked<?php }?>>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="uyelik" name="uyelik" value="1"  <?php if($row['uyelik'] == '1'  ) { ?>checked<?php }?> onclick="uyelers(this.checked);">
                                            <label class="custom-control-label" for="uyelik"></label>
                                        </div>
                                    </div>
                                    <div id="uyelers" class="w-100"  <?php if($row['uyelik'] == '0'  ) { ?>style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="uye_yonet" class="w-100" ><?=$diller['adminpanel-text-207']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="uye_yonet" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="uye_yonet" name="uye_yonet" value="1"<?php if($row['uye_yonet'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="ticket" name="ticket" value="1" <?php if($row['ticket'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="uyelik_ayar" name="uyelik_ayar" value="1" <?php if($row['uyelik_ayar'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="ziyaretci_istatistik" name="ziyaretci_istatistik" value="1" <?php if($row['ziyaretci_istatistik'] == '1'  ) { ?>checked<?php }?> ">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="kampanya" name="kampanya" value="1"  <?php if($row['kampanya'] == '1'  ) { ?>checked<?php }?> onclick="campaigne(this.checked);">
                                            <label class="custom-control-label" for="kampanya"></label>
                                        </div>
                                    </div>
                                    <div id="campaigne" class="w-100" <?php if($row['kampanya'] == '0'  ) { ?> style="display:none !important;" <?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="indirimkod" class="w-100" ><?=$diller['adminpanel-text-213']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="indirimkod" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="indirimkod" name="indirimkod" value="1"<?php if($row['indirimkod'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="eposta_yonet" name="eposta_yonet" value="1" <?php if($row['eposta_yonet'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="sms_yonet" name="sms_yonet" value="1" <?php if($row['sms_yonet'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="bildirim_gonder" name="bildirim_gonder" value="1" <?php if($row['bildirim_gonder'] == '1'  ) { ?>checked<?php }?> >
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="icerik_yonetim" name="icerik_yonetim" value="1"  <?php if($row['icerik_yonetim'] == '1'  ) { ?>checked<?php }?> onclick="modulyonet(this.checked);">
                                            <label class="custom-control-label" for="icerik_yonetim"></label>
                                        </div>
                                    </div>
                                    <div id="modulyonet" class="w-100"  <?php if($row['icerik_yonetim'] == '0'  ) { ?>style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                <label  for="sayfa_yonet" class="w-100" ><?=$diller['adminpanel-text-220']?></label>
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    <input type="hidden" name="sayfa_yonet" value="0"">
                                                    <input type="checkbox" class="custom-control-input" id="sayfa_yonet" name="sayfa_yonet" value="1"<?php if($row['sayfa_yonet'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="blog_hizmet" name="blog_hizmet" value="1" <?php if($row['blog_hizmet'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="galeri" name="galeri" value="1" <?php if($row['galeri'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="ptable" name="ptable" value="1" <?php if($row['ptable'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="icerik_diger" name="icerik_diger" value="1" <?php if($row['icerik_diger'] == '1'  ) { ?>checked<?php }?> >
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="modul" name="modul" value="1"  <?php if($row['modul'] == '1'  ) { ?>checked<?php }?> onclick="icerikyonetim(this.checked);">
                                            <label class="custom-control-label" for="modul"></label>
                                        </div>
                                    </div>
                                    <div id="icerikyonetim" class="w-100" <?php if($row['modul'] == '0'  ) { ?> style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="modul_header_footer" name="modul_header_footer" value="1" <?php if($row['modul_header_footer'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="sirala" name="sirala" value="1"  <?php if($row['sirala'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="modul_vitrin" name="modul_vitrin" value="1"  <?php if($row['modul_vitrin'] == '1'  ) { ?>checked<?php }?>>
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="modul_diger" name="modul_diger" value="1"  <?php if($row['modul_diger'] == '1'  ) { ?>checked<?php }?>>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="entegrasyon" name="entegrasyon" value="1"   <?php if($row['entegrasyon'] == '1'  ) { ?>checked<?php }?> onclick="entegra(this.checked);">
                                            <label class="custom-control-label" for="entegrasyon"></label>
                                        </div>
                                    </div>
                                    <div id="entegra" class="w-100"  <?php if($row['entegrasyon'] == '0'  ) { ?> style="display:none !important;"<?php }?>>
                                        <div class="row pl-3">
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="entegrasyon_pazar" name="entegrasyon_pazar" value="1" <?php if($row['entegrasyon_pazar'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="entegrasyon_urun" name="entegrasyon_urun" value="1" <?php if($row['entegrasyon_urun'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="entegrasyon_sms" name="entegrasyon_sms" value="1"  <?php if($row['entegrasyon_sms'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="entegrasyon_eposta" name="entegrasyon_eposta" value="1"  <?php if($row['entegrasyon_eposta'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="entegrasyon_map" name="entegrasyon_map" value="1"  <?php if($row['entegrasyon_map'] == '1'  ) { ?>checked<?php }?> >
                                            ...
                                            <div class="form-group col-md-3 mb-4">
                                                ...
                                                <div class="custom-control custom-switch custom-switch-lg">
                                                    ...
                                                    <input type="checkbox" class="custom-control-input" id="parasut" name="parasut" value="1" <?php if($row['parasut'] == '1'  ) { ?>checked<?php }?>>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="yapilandirma" name="yapilandirma" value="1" <?php if($row['yapilandirma'] == '1'  ) { ?>checked<?php }?> ">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="tema_ayarlar" name="tema_ayarlar" value="1" <?php if($row['tema_ayarlar'] == '1'  ) { ?>checked<?php }?> ">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="bell" name="bell" value="1" <?php if($row['bell'] == '1'  ) { ?>checked<?php }?> ">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="kisayol_ekle" name="kisayol_ekle" value="1" <?php if($row['kisayol_ekle'] == '1'  ) { ?>checked<?php }?> ">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="veriler" name="veriler" value="1" <?php if($row['veriler'] == '1'  ) { ?>checked<?php }?> ">
                                    ...
                                    <div class="form-group col-md-3 mb-4">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-lg">
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="gelenkutusu" name="gelenkutusu" value="1" <?php if($row['gelenkutusu'] == '1'  ) { ?>checked<?php }?> ">
                            ...
                            <div class="w-100 border-top pt-3">
                                <button class="btn btn-success btn-block" name="perEdit">
