...
class Shopier
{
    ...
    public function generateFormObject($order_id, $order_total, $callback_url)
    {
        ...
        $SiparisiAl = $db->prepare("select siparis_no from siparisler where siparis_no=:siparis_no and onay=:onay");
        ...
        /* Shopier order platform update */
        $guncelle = $db->prepare("UPDATE siparisler SET
            shopier_id=:shopier_id
         WHERE siparis_no= {$siparisim['siparis_no']}   
        ");
        $sonuc = $guncelle->execute(array(
            'shopier_id' => $args["platform_order_id"]
        ));
        /*  <========SON=========>>> Shopier order platform update SON */
