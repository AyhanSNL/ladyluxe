...
?>
<title><?php echo $diller['users-adresler-yeni-seo-title']; ?> - <?php echo $ayar['site_baslik']?></title>
    ...
    <div class="user_subpage_div">
        ...
        <div class="user_page_header_subpage">
           ...
           <i class="las la-angle-double-right"></i>
            ...
            <i class="las la-angle-double-right"></i>
            <a href="hesabim/yeni-adres-ekle/"><?=$diller['users-panel-baglanti-text11']?></a>
        </div>
        <!--  <========SON=========>>> Header SON !-->
        ...
        <div class="user_subpage_coupon_content">
            ...
            <!-- Adres Form Area !-->
            <form action="user-address-addpost" method="post">
                        ...
                        <div class="row ">
                            ...
                            <div class="form-group col-md-12" >
                                <div class="custom-control custom-checkbox" style=" border: 1px solid #49a781; border-radius: 3px; padding-top: 8px; padding-bottom: 8px; background-color: #f6fffa; color: #000;" >
                                    ...
                                    <input type="checkbox" name="secili" value="1" class="custom-control-input" id="secili" <?php if($_SESSION['form_temp']['varsayilan'] == '1'  ) { ?>checked<?php }?> >
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="baslik" value="<?=$_SESSION['form_temp']['baslik']?>"  id="baslik"   class="form-control" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="soyisim"  id="soyisim"   class="form-control" value="<?=$_SESSION['form_temp']['soyisim']?>" autocomplete="off">
                            </div>
                            <?php if($odemeayar['faturasiz_teslimat'] == '0' ) {?>
                                 <div class="form-group col-md-12">
                                <label for="eposta">* <?=$diller['teslimat-sayfa-form-eposta']?></label>
                                <div style="width: 100%; position: relative  ">
                                    <input type="text" name="eposta"   id="eposta"  class="form-control" value="<?=$_SESSION['form_temp']['eposta']?>" autocomplete="off">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div style="width: 100%; position: relative; display: flex;  ">
                                    <div style="width: 100%;  ">
                                        <input type="text" name="tel"   id="tel"  class="form-control" value="<?=$_SESSION['form_temp']['telefon']?>" autocomplete="off" placeholder="(___) ___-____" >
                            ...
                            <div class="form-group col-md-6">
                                <label for="tel">* <?=$diller['teslimat-sayfa-form-telefon']?></label>
                                <div style="width: 100%; position: relative; display: flex;  ">
                                    <input type="text" name="tel"  id="tel"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['telefon']?>" placeholder="(___) ___-____" >
                                    <div class="teslimat-icon"><i class="fa fa-phone"></i></div>
                                </div>
                            </div>
                            <?php }?>
                            ...
                            <div class="teslimat-form-area">
                                ...
                                <div class="fatura-secim-bireysel row" >
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="fatura_isim"  id="fatura_isim"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_isim']?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="fatura_soyisim">* <?=$diller['teslimat-sayfa-form-soyisim']?></label>
                                        <input type="text" name="fatura_soyisim"  id="fatura_soyisim"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_soyisim']?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="fatura_tc">* <?=$diller['teslimat-sayfa-form-tc']?></label>
                                        <input type="number" name="fatura_tc" placeholder="************" id="fatura_tc"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_tc']?>">
                                    </div>
                                    <!-- Bireysel SON !-->
                                </div>
                                ...
                                <div class="fatura-secim-kurumsal row" >
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="fatura_firma_unvan"  id="fatura_firma_unvan"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_unvan']?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="fatura_vergi_dairesi">* <?=$diller['teslimat-sayfa-form-fatura-firma-vergidaire']?></label>
                                        <input type="text" name="fatura_vergi_dairesi"  id="fatura_vergi_dairesi"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_vd']?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="fatura_vergi_no">* <?=$diller['teslimat-sayfa-form-fatura-firma-vergino']?></label>
                                        <input type="number" name="fatura_vergi_no"  id="fatura_vergi_no"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_vn']?>">
                                    </div>
                                    <!-- Kurumsal SON !-->
                                </div>
                                ...
                                <?php if($Fatura_ulkeCek->rowCount()>'0'  ) {?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="fatura_postakodu" placeholder="______"  id="fatura_postakodu" maxlength="5"  class="form-control" autocomplete="off" value="<?=$_SESSION['form_temp']['fatura_posta']?>" >
                                        </div>
                                        <div class="form-group col-md-12">
