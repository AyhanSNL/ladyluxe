...
<?php if($SiparisiAl->rowCount()>'0'  ) {?>
    <div class="ccard-payment-iyzico-main">
        <div class="ccard-payment-iyzico-left">
            ...
            <?php if($siparisim['kdv_tutar'] > '0' && $siparisim['kdv_tutar'] == !null ) {?>
            <div class="ccard-payment-iyzico-left-paycount-sm">
                <div class="ccard-payment-iyzico-left-paycount-text1">
        ...
        <div class="ccard-payment-iyzico-right">
            <?php if($odemeayar['iyzico_taksit_sayi'] != '0' ) {?>
                <?php if($siparisim['taksit_durum'] == '0'  ) {?>
                    <div class="ccard-payment-iyzico-uyari">
                        <i class="fa fa-info-circle"></i>  <?=$diller['kart-odeme-text-5']?>
                    </div>
                <?php }?>
            <?php }?>
            <?php include 'includes/template/vpos/iyzico/iyzico.php'; ?>
        </div>
    </div>
<?php }else { ?>
<?php
