...
<?php
$seo_url = htmlspecialchars(strip_tags($_GET['seo_url']));
if(strip_tags(htmlspecialchars($_GET['seo_url'])) != $_GET['seo_url']  ) {
    header('Location:'.$ayar['site_url'].'404');
    exit();
}
include 'includes/template/helper/category_detail/fonksiyonlar.php';
if($katGetir->rowCount()>'0') {
    ?>
    <title><?=$seotitle?> - <?php echo $ayar['site_baslik'] ?></title>
    <meta name="description" content="<?php echo "$katMain[meta_desc]" ?>">
    <meta name="keywords" content="<?php echo "$katMain[tags]" ?>">
    <meta name="news_keywords" content="<?php echo "$katMain[tags]" ?>">
    ...
    <div class="cat-detail-main-div" ><div class="cat-detail-main-div-in">
            ...
            <?php if ($islemayar['baslik_yer'] == '1') { ?>
                <div class="cat-right-header-out" style="width: 100%; padding: 0;  ">
                    <div class="cat-right-header">
                        <div class="cat-right-links">
                            <?php if($katMain['ust_id'] > '0' ) {?>
                                <?php if($ustKatSorguSayi >'0') {?>
                                    <?php if($ustKatSorguSayi2 >'0') {?>
                                        <?php if($ustKatSorguSayi3 >'0') {?>
                                            <?php if($ustKatSorguSayi4 >'0') {?>
                                                <a href="<?=$ustKat4['seo_url']?>/"><?=$ustKat4['baslik']?></a>
                                                <i class="fa fa-angle-right"></i>
                                            <?php }?>
                                            <a href="<?=$ustKat3['seo_url']?>/"><?=$ustKat3['baslik']?></a>
                                            <i class="fa fa-angle-right"></i>
                                        <?php }?>
                                        <a href="<?=$ustKat2['seo_url']?>/"><?=$ustKat2['baslik']?></a>
                                        <i class="fa fa-angle-right"></i>
                                    <?php }?>
                                    <a href="<?=$ustKat['seo_url']?>/"><?=$ustKat['baslik']?></a>
                                <?php }?>
                                <i class="fa fa-angle-right"></i>
                                <a href="<?=$katMain['seo_url']?>/"><?=$katMain['baslik']?></a>
                            <?php }?>
                        </div>
                        <div class="cat-right-head-text"
                             style="color: #<?= $islemayar['baslik_color'] ?>; <?php if ($islemayar['aciklama_durum'] == '0') { ?>margin-bottom:0; <?php } ?><?php if ($katMain['spot'] == null) { ?>margin-bottom:0;<?php } ?>">
                            <?=$katMain['baslik']?>
                        </div>
                        <?php if ($islemayar['aciklama_durum'] == '1') { ?>
                            <div class="cat-right-desc" style="color: #<?= $islemayar['spot_color'] ?>;">
                                <?=$katMain['spot']?>
                            </div>
                        <?php } ?>
                    </div>
            ...
            <!-- left Nav !-->
            <?php include 'includes/template/helper/category_detail/left-bar.php'; ?>
            <!-- Products Area !-->
            <div class="cat-right-main">
                <?php if ($islemayar['baslik_yer'] == '2') { ?>
                    <div class="cat-right-header-out">
                        <div class="cat-right-header">
                            ...
                            <?php }?>
                            <div class="cat-right-head-text"
                                 style="color: #<?= $islemayar['baslik_color'] ?>; <?php if ($islemayar['aciklama_durum'] == '0') { ?>margin-bottom:0;<?php } ?>">
                                <?=$katMain['baslik']?>
                            </div>
                            <?php if ($islemayar['aciklama_durum'] == '1') { ?>
                                <div class="cat-right-desc" style="color: #<?= $islemayar['spot_color'] ?>;">
                                ...
                                <div class="cat-left-box-t" style="border-bottom: 0; padding: 5px 0 0 0;">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <?php if($_GET['stok'] == '0' || !isset($_GET['stok'])    ) {?>
                                            <input type="checkbox" class="custom-control-input" id="stok" onclick="javascript:window.location='<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$StokParselMain?>&stok=1'" >
                                        <?php }?>
                        ...
                        <div class="cat-right-elements-right">
                            <div class="cat-right-elements-right-siralama">
                                <select name="s" id="dynamic_select" class="select nice-select-cat-detail" required>
                                    <?php if ($islemayar['sirala_harf'] == '1') { ?>
                                        <option value="<?=$browser_link?>?s=1<?=$siralamaURL?>"<?php if($_GET['s'] == '1'  ) { ?>selected<?php }?><?php if(!isset($_GET['s']) && $islemayar['siralama_secim'] == '1') { ?>selected<?php }?>><?=$diller['kategori-detay-text13']?></option>
                                    <?php } ?>
                                    <?php if ($islemayar['sirala_artan'] == '1') { ?>
                                        <option value="<?=$browser_link?>?s=2<?=$siralamaURL?>"<?php if($_GET['s'] == '2'  ) { ?>selected<?php }?><?php if(!isset($_GET['s']) && $islemayar['siralama_secim'] == '2') { ?>selected<?php }?>><?=$diller['kategori-detay-text14']?></option>
                                    <?php } ?>
                                    <?php if ($islemayar['sirala_azalan'] == '1') { ?>
                                        <option value="<?=$browser_link?>?s=3<?=$siralamaURL?>"<?php if($_GET['s'] == '3'  ) { ?>selected<?php }?><?php if(!isset($_GET['s']) && $islemayar['siralama_secim'] == '3') { ?>selected<?php }?>><?=$diller['kategori-detay-text15']?></option>
                                    <?php } ?>
                                    <?php if ($islemayar['sirala_yeni'] == '1') { ?>
                                        <option value="<?=$browser_link?>?s=4<?=$siralamaURL?>"<?php if($_GET['s'] == '4'  ) { ?>selected<?php }?><?php if(!isset($_GET['s']) && $islemayar['siralama_secim'] == '4') { ?>selected<?php }?>><?=$diller['kategori-detay-text16']?></option>
                                    <?php } ?>
                                    <?php if ($islemayar['sirala_populer'] == '1') { ?>
                                        <option value="<?=$browser_link?>?s=5<?=$siralamaURL?>"<?php if($_GET['s'] == '5'  ) { ?>selected<?php }?><?php if(!isset($_GET['s']) && $islemayar['siralama_secim'] == '5') { ?>selected<?php }?>><?=$diller['kategori-detay-text17']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                ...
                <?php if($_GET['editor']== '1' || $_GET['uk']== '1' || $_GET['new']=='1' || $_GET['firsat']=='1' || $_GET['indirim']=='1' || $_GET['taksit']=='1' || $_GET['hizlikargo']== '1' || $_GET['stok'] == '1' || isset($_GET['min']) || isset($_GET['max'] ) || isset($_GET['marka']) || isset($_GET['oz'])) {?>
                    ...
                    <div class="cat-left-box-out-filterbox-out" >
                        <?php if(isset($_GET['oz'])  ) {?>
                            <?php foreach ($_GET['oz'] as $ozFiltreDelete) {
                                $ozFiltreDeleteSorgu = $db->prepare("select * from filtre_ozellik where ozellik_id=:ozellik_id ");
                                $ozFiltreDeleteSorgu->execute(array(
                                    'ozellik_id' => $ozFiltreDelete
                                ));
                                $ozUstDelet = $ozFiltreDeleteSorgu->fetch(PDO::FETCH_ASSOC);
                                /* Özellik Filtreleri Parseli */
                                $ozellikFiltreParsel  = $parseParts['query'];
                                $oldOZELLIKParselMain   = '&oz[]='.$ozUstDelet['ozellik_id'].'';
                                $newOZELLIKParselMain   = '';
                                $ozellikFiltreParsel = str_replace($oldOZELLIKParselMain, $newOZELLIKParselMain, $ozellikFiltreParsel);
                                /*  <========SON=========>>> Özellik Filtreleri Parseli SON */
                                /* Grubu Göster */
                                $ozGrupFiltreDeleteSorgu = $db->prepare("select * from filtre_ozellik_grup where real_grup_id=:real_grup_id ");
                                $ozGrupFiltreDeleteSorgu->execute(array(
                                    'real_grup_id' => $ozUstDelet['grup_id']
                                ));
                                $ozGrupUstDelet = $ozGrupFiltreDeleteSorgu->fetch(PDO::FETCH_ASSOC);
                                /*  <========SON=========>>> Grubu Göster SON */
                                ?>
                                <a href="<?=$browser_link?>?<?=$ozellikFiltreParsel?>" class="<?=$islemayar['secili_filtre_button']?> tooltip-bottom"  data-tooltip="<?=$diller['kategori-detay-text34']?>"><?=$ozGrupUstDelet['baslik']?> : <?=$ozUstDelet['kisa_baslik']?> <i class="ion-backspace"></i></a>
                            <?php }?>
                        <?php } ?>
                        <?php if(isset($_GET['marka'])  ) {?>
                            <?php foreach ($_GET['marka'] as $markFiltreDelete) {
                                $markaFiltreSil = $db->prepare("select * from urun_marka where id=:id ");
                                $markaFiltreSil->execute(array(
                                    'id' => $markFiltreDelete
                                ));
                                $markaustFiltre = $markaFiltreSil->fetch(PDO::FETCH_ASSOC);
                                /* Markalar Parseli */
                                $MarkaParselMain  = $parseParts['query'];
                                $oldMARKAParselMain   = '&marka[]='.$markaustFiltre['id'].'';
                                $newMARKAParselMain   = '';
                                $MarkaParselMain = str_replace($oldMARKAParselMain, $newMARKAParselMain, $MarkaParselMain);
                                /*  <========SON=========>>> Markalar Parseli SON */
                                ?>
                                <a href="<?=$browser_link?>?<?=$MarkaParselMain?>" class="<?=$islemayar['secili_filtre_button']?> tooltip-bottom"  data-tooltip="<?=$diller['kategori-detay-text34']?>"><?=$markaustFiltre['baslik']?> <i class="ion-backspace"></i></a>
                            <?php }?>
                        <?php }?>
                        <?php if($_GET['uk'] == '1'  ) {?>
                        ...
                        <?php }?>
                        <a href="<?=$browser_link?>" class="<?=$islemayar['tumfiltre_kaldir_button']?> "><?=$diller['kategori-detay-text20']?></a>
                    </div>
                                                    ...
                                                    <?php if($urun['siparis_islem'] == '0'  ) {?>
                                                        ...
                                                        <?php }else { ?>
                                                            <form action="addtocart" method="post" >
                                                                ...
                                                                <input name="token" type="hidden" value="<?=md5('categoryCallBack')?>">
                                                                <input name="actualCheck" type="hidden" value="<?=$parseParts['query']?>">
                                                                <input name="categoryRequest" type="hidden" value="<?=$seo_url?>">
                ...
                <?php if($TotalData > $islemayar['urun_liste_limit']  ) {?>
                    <div class="category-pagination-out">
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-sm <?php if($islemayar['sayfalama_hiza'] == '1' ) { ?>justify-content-center<?php }?><?php if($islemayar['sayfalama_hiza'] == '2' ) { ?>justify-content-end<?php }?>">
                                <?php if($Sayfa > 1){?>
                                    <li class="page-item"><a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=1"><?=$diller['sayfalama-ilk']?></a></li>
                                    <li class="page-item"><a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=<?=$Sayfa - 1?>"><?=$diller['sayfalama-onceki']?></a></li>
                                <?php } ?>
                                <?php
                                for($i = $Sayfa - $GorunenSayfa; $i < $Sayfa + $GorunenSayfa +1; $i++){ if($i > 0 and $i <= $Sayfa_Sayisi){
                                    if($i == $Sayfa){
                                        ...
                                        <li class="page-item active" aria-current="page">
                                            <a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=<?=$i?>"><?=$i?><span class="sr-only">(current)</span></a>
                                        </li>
                                    <?php }else{?>
                                        <li class="page-item"><a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=<?=$i?>"><?=$i?></a></li>
                                    <?php }}}?>
                                <?php if($Sayfa != $Sayfa_Sayisi){?>
                                    <li class="page-item"><a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=<?=$Sayfa + 1?>"><?=$diller['sayfalama-sonraki']?></a></li>
                                    <li class="page-item"><a class="page-link" href="<?=$browser_link?><?php if(!isset($_GET['s'])) { ?>?s=<?=$islemayar['siralama_secim']?><?php }else{?>?<?php } ?><?=$sayfalamaParsel?>&p=<?=$Sayfa_Sayisi?>"><?=$diller['sayfalama-son']?></a></li>
                                <?php } ?>
                            </ul>
                        </nav>
                    </div>
