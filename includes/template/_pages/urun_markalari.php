...
<?php
$seo_url = trim(strip_tags($_GET['seo_url']));
if(strip_tags(htmlspecialchars($_GET['seo_url'])) != $_GET['seo_url']  ) {
    header('Location:'.$ayar['site_url'].'404');
    exit();
}
include 'includes/template/helper/urun_marka/fonksiyonlar.php';
?>
<title><?=$seotitle?> - <?php echo $ayar['site_baslik'] ?></title>
<meta name="description" content="<?php echo "$markaMain[meta_desc]" ?>">
<meta name="keywords" content="<?php echo "$markaMain[tags]" ?>">
<meta name="news_keywords" content="<?php echo "$markaMain[tags]" ?>">
        ...
        <div class="page-banner-main">
            <div class="page-banner-in-text">
                ...
                <div class="page-banner-links ">
                    ...
                    <span>/</span>
                    <a href="marka-listesi/"><?=$diller['kategori-detay-text40']?></a>
                    <span>/</span>
                    <a><?=$markaMain['baslik']?></a>
                </div>
            </div>
...
<div class="cat-detail-main-div" ><div class="cat-detail-main-div-in">
        ...
        <!-- left Nav !-->
        <?php include 'includes/template/helper/urun_marka/left-bar.php'; ?>
                ...
                <div class="cat-right-header2">
                    <div class="cat-right-header2-left">
                        <div class="cat-right-head-text" style="color: #000; <?php if ($markaMain['spot']==null) { ?>margin-bottom:0;<?php } ?>">
                            <?=$markaMain['baslik']?> (<?=$TotalData?>)
                        </div>
                        <?php if($markaMain['spot']==!null  ) {?>
                    ...
                    <div class="cat-right-header2-right">
                        <?php if($markaMain['gorsel']  == !null ) {?>
                            <img src="images/uploads/<?=$markaMain['gorsel']?>" alt="<?=$markaMain['baslik']?>">
                        <?php }?>
                    </div>
                </div>
            </div>
                                                ...
                                                <?php if($urun['siparis_islem'] == '0'  ) {?>
                                                    ...
                                                    <?php }else { ?>
                                                        <form action="addtocart" method="post" >
                                                            ...
                                                            <input name="token" type="hidden" value="<?=md5('brandCallBack')?>">
