...
if($odemeayar['kargo_sistemi']== '1'  ) {
    $kargoTablo = "    <table width='100%' style='padding: 8px; border-bottom: 1px solid #EBEBEB;'>
                        <tr>
                            ...
                            <td width='2%'>:</td>
                            <td width='52%' style='font-weight: 500; font-size: 14px ; text-align: right;'>".number_format($siparis_kargotoplam, $paraDurumu['para_format'])." ".$paraDurumu['kod']."</td>
                        </tr>
                    </table>  ";
}else{
    $kargoTablo = '';
...
if($siparis_kdvtoplam > '0'  ) {
    $kdvTablo = "    <table width='100%' style='padding: 8px; border-bottom: 1px solid #EBEBEB;'>
                        <tr>
                            ...
                            <td width='2%'>:</td>
                            <td width='52%' style='font-weight: 500; font-size: 14px ; text-align: right;'>".number_format($siparis_kdvtoplam, $paraDurumu['para_format'])." ".$paraDurumu['kod']."</td>
                        </tr>
                    </table> ";
}else{
    $kdvTablo = '';
...
if($siparis_indirimtutar > '0'  ) {
    $indirimTablo = "<table width='100%' style='padding: 8px; border-bottom: 1px solid #EBEBEB;'>
                        <tr>
                            ...
                            <td width='2%'>:</td>
                            <td width='52%' style='font-weight: 500; font-size: 14px ; text-align: right;'>- ".number_format($siparis_indirimtutar, $paraDurumu['para_format'])." ".$paraDurumu['kod']."</td>
                        </tr>
                    </table>";
}else{
    $indirimTablo = '';
...
if($odemeayar['havale_odeme_bildirim'] == '1' ) {
    $odemeButton = "            <!-- Ödeme Bildirim Butonu Ekle  !-->
            <div id='bilgiBox' style='width: 100%; background-color: #fff9e6; border:1px solid #f1d9d2; font-size: 13px ; padding: 10px; color: #000; box-sizing: border-box; margin-bottom: 10px;   '>
                ".$diller['oto-eposta-havale-eft-5']."
            </div>
            <div style='width: 100%; margin-bottom: 40px; '>
            <a href='".$siteadres."odeme-bildirimi/?sID=".$siparis_id."' style='display:block; text-align:center; padding: 8px 15px; font-size: 14px ; background-color: dodgerblue; color: #FFF; text-decoration: none; '>
             ".$diller['oto-eposta-havale-eft-6']."
            </a>
            </div>
            <!--  <========SON=========>>> Ödeme Bildirim Butonu Ekle  --!-->";
}else{
    $odemeButton = '';
}

/* Ürünleri Çek */
$urunAktar_Eposta = $db->prepare("select * from sepet where sepet_durum=:sepet_durum and ip=:ip ");
...
foreach ($urunAktar_Eposta as $urunPosta) {
    if($odemeayar['havale_doviz_durum'] == '1' ) {
        $urun_kdvsiztutar = kurhesapla($varsayilankur['deger'],$secilikur['deger'],$urunPosta['havale_kdvsiz_fiyat']);
        $urun_kargotutar =  kurhesapla($varsayilankur['deger'],$secilikur['deger'],$urunPosta['kargo_tutar']);
        $urun_kdvtutar = kurhesapla($varsayilankur['deger'],$secilikur['deger'],$urunPosta['havale_kdv_tutar']);
        $urun_ekfiyat =  kurhesapla($varsayilankur['deger'],$secilikur['deger'],$urunPosta['ek_fiyat_tekil']);
    }else{
        $urun_kdvsiztutar = $urunPosta['havale_kdvsiz_fiyat'];
        $urun_kargotutar =  $urunPosta['kargo_tutar'];
        $urun_kdvtutar = $urunPosta['havale_kdv_tutar'];
        $urun_ekfiyat = $urunPosta['ek_fiyat_tekil'];
    }
    ...
    if($urunPosta['havale_kdv_tutar'] > '0'  ) {
...
<div style='width: auto; margin: 0 auto;      '>
    ...
    <div id='Main_Div' style=' box-sizing: border-box;  margin: 0 auto; width: ".$epostatema['ana_div_width']."px; background-color: #".$epostatema['ana_div']."; color: #".$epostatema['ana_div_text']."; border-radius: ".$epostatema['ana_div_radius']."; padding: ".$epostatema['ana_div_padding']."; border: ".$epostatema['ana_div_border_size']."px solid #".$epostatema['ana_div_border']."; font-size: ".$epostatema['ana_div_font_size']."px ; '>
            ...
            <table width='100%' style='color: #".$epostatema['ana_div_baslik_color']."; font-size:".$epostatema['ana_div_baslik_size']."px; font-weight: ".$epostatema['ana_div_baslik_weight']."; margin-bottom: 40px;'>
                <tr>
                    <td width='80%' >".$diller['oto-eposta-havale-eft-1']."</td>
           ...
           <!-- Sipariş Sahibi !-->
            ...
            <div style='width: 95%;  margin-bottom: 40px; '>
                ".$diller['oto-eposta-havale-eft-2']."
            </div>
            <!--  <========SON=========>>> İçerik SON !-->
            ...
            <div style='width: 100%; border-top: 1px solid #".$epostatema['ana_div_in_border']."; box-sizing: border-box; margin-bottom: 20px;  font-size: 13px ;  '>
                ...
                <table width='100%' style='padding: 8px 0; border-bottom: 1px solid #".$epostatema['ana_div_in_border'].";'>
                    <tr>
                        ...
                        <td width='4%' valign='top' >:</td>
                        <td width='65%' valign='top' style='font-weight: 500;'>".$diller['oto-eposta-content-text18']."</td>
                    </tr>
                </table>
                <table width='100%' style='padding: 8px 0; border-bottom: 1px solid #".$epostatema['ana_div_in_border'].";'>
                    <tr>
...
// Alıcı //
    $mail->AddBCC($eposta, "");
// Konu //
    $mail->Subject = '✅'  .$diller['oto-eposta-havale-eft-1'];
// Mesaj //
    $mail->isHTML(true);
...
<div style='width: auto; margin: 0 auto;      '>
    ...
    <div id='Main_Div' style=' box-sizing: border-box;  margin: 0 auto; width: ".$epostatema['ana_div_width']."px; background-color: #".$epostatema['ana_div']."; color: #".$epostatema['ana_div_text']."; border-radius: ".$epostatema['ana_div_radius']."; padding: ".$epostatema['ana_div_padding']."; border: ".$epostatema['ana_div_border_size']."px solid #".$epostatema['ana_div_border']."; font-size: ".$epostatema['ana_div_font_size']."px ; '>
            ...
            <table width='100%' style='color: #".$epostatema['ana_div_baslik_color']."; font-size:".$epostatema['ana_div_baslik_size']."px; font-weight: ".$epostatema['ana_div_baslik_weight']."; margin-bottom: 40px;'>
                <tr>
                    <td width='80%' >".$diller['oto-eposta-havale-eft-3']."</td>
            ...
            <!-- İçerik !-->
            <div style='width: 95%;  margin-bottom: 40px; '>
                ".$diller['oto-eposta-havale-eft-4']."
            </div>
            <!--  <========SON=========>>> İçerik SON !-->
...
// Konu //
    $mail->Subject = '🎉' .$diller['oto-eposta-havale-eft-3'];
// Mesaj //
    $mail->isHTML(true);
