...
foreach ($SepetAktif_Urun_Db_Aktar as $sepetdb) {
    ...
    if($odemeayar['havale_doviz_durum'] == '1' ) {
        $urun_kdvsiztutar = kurhesapla($varsayilankur['deger'],$secilikur['deger'],$sepetdb['havale_kdvsiz_fiyat']);
        $urun_kargotutar =  kurhesapla($varsayilankur['deger'],$secilikur['deger'],$sepetdb['kargo_tutar']);
        $urun_kdvtutar = kurhesapla($varsayilankur['deger'],$secilikur['deger'],$sepetdb['havale_kdv_tutar']);
        $urun_ekfiyat =  kurhesapla($varsayilankur['deger'],$secilikur['deger'],$sepetdb['ek_fiyat_tekil']);
    }else{
        $urun_kdvsiztutar = $sepetdb['havale_kdvsiz_fiyat'];
        $urun_kargotutar =  $sepetdb['kargo_tutar'];
        $urun_kdvtutar = $sepetdb['havale_kdv_tutar'];
    ...
    $kaydet = $db->prepare("INSERT INTO siparis_urunler SET 
        ...
        havale_kdvsiz_tutar=:havale_kdvsiz_tutar,
...
");
    $sonuc = $kaydet->execute(array(
        ...
        'havale_kdvsiz_tutar' => $urun_kdvsiztutar,
        'havale_kdv_tutar' => $urun_kdvtutar,
